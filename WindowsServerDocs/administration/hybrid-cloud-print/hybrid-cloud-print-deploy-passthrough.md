...
ms.locfileid: "59887114"
---
# <a name="deploy-windows-server-hybrid-cloud-print-with-passthrough-authentication"></a>통과 인증을 사용 하 여 Windows Server 하이브리드 클라우드 인쇄를 배포 합니다.
...
- 3단계: 통과 인증을 사용 하 여 Azure 응용 프로그램 프록시 (AAP) 설치
...
### <a name="step-3---install-azure-application-proxy-aap-with-passthrough-authentication"></a>3 단계-통과 인증을 사용 하 여 Azure 응용 프로그램 프록시 (AAP) 설치
...
4. 엔터프라이즈 클라우드 인쇄 서비스에 대 한 위의 3을 반복 하 고 엔터프라이즈 클라우드 인쇄 서비스에 내부 URL을 제공 합니다.

    >   참고: Https://&lt;services machine 끝점&gt;mcs URL 아래에 언급 된 Mopria 클라우드 서비스 및/또는 엔터프라이즈 클라우드 인쇄 서비스에 대해 설정한 외부 URL 이어야 합니다.
...
- 엔터프라이즈 클라우드 인쇄 정책 그룹을 찾아 아래 지침에 따라 정책을 구성 합니다.
    ...
    - MopriaDiscoveryResourceId "앱 ID URI" 웹 앱의 = 단계 2.8에 검색 끝점에 대 한 API를 등록 합니다.  설정에서 찾을 수 있습니다-> 앱의 속성
    - CloudPrintResourceId "앱 ID URI" 웹 앱의 = 단계 2.8에 인쇄 끝점용 API를 등록 합니다. 설정에서 찾을 수 있습니다-> 앱의 속성
...
- OMA-URI
    ...
    - `MopriaDiscoveryResourceId = ./Vendor/MSFT/Policy/Config/EnterpriseCloudPrint/MopriaDiscoveryResourceId`
        - 값 = "앱 ID URI" 웹 앱의 단계 2.8에 검색 끝점에 대 한 API를 등록 합니다.  설정에서 찾을 수 있습니다-> 앱의 속성
    - `CloudPrintResourceId = ./Vendor/MSFT/Policy/Config/EnterpriseCloudPrint/CloudPrintResourceId`
        - 값 = "앱 ID URI" 웹 앱의 단계 2.8에 인쇄 끝점용 API를 등록 합니다. 설정에서 찾을 수 있습니다-> 앱의 속성
...
## <a name="verifing-the-deployment"></a>배포 검사
Azure ad 가입 장치 구성 MDM 정책이 포함 된:
- 웹 브라우저를 열고 https:// 이동할&lt;services machine 끝점 &gt; /mcs/서비스
