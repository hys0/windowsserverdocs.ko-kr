...
추가 역할 및 기능 마법사를 열고 역할 및 기능 마법사 및 서버 풀의 역할, 역할 서비스 및 서버 기능을 제거 하거나 추가할 수를 제거 하는 명령에는 **관리** 서버 관리자의 메뉴 콘솔 및 **작업** 메뉴의 **역할 및 기능** 역할이 나 그룹 페이지에 바둑판식으로 배열 합니다. 역할이나 기능을 추가하거나 제거하는 방법에 대한 자세한 내용은 [Install or Uninstall Roles, Role Services, or Features](install-or-uninstall-roles-role-services-or-features.md)를 참조하세요.
