...
```
2013 년 3 월 31 일 오전 9:00에 발생 한 년 3 월 31 일에 백업 복구를 실행 하려면 \\\\? \Volume{cc566d14-44a0-11d9-9d93-806e6f6e6963}\,을 입력 합니다.
```
wbadmin start recovery -version:03/31/2013-09:00 -itemType:Volume 
-items:\\?\Volume{cc566d14-44a0-11d9-9d93-806e6f6e6963}\
```
2013 년 4 월 30 일 오전 9:00에 servername\share \\공유 폴더 \\공유 폴더의 백업 복구를 실행 하려면 다음을 입력 합니다.
```
