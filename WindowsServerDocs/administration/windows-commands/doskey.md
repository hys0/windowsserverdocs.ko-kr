...
- 매크로 만들기
  ...
  |      $\*      | 매크로 이름을 입력할 때를 지정 하려는 모든 명령줄 정보를 나타냅니다. 특수 **$ 문자\\** **는 일괄** 처리 매개 변수 $1 ~ $9과 유사 하 고, 다음의 두 가지 중요 한 차이점이 있습니다.  \* 매크로 \* 에서 매크로 이름을로 대체 **$ \\** 합니다. |
...
```
앞의 예에서 TX 매크로 temp 폴더에 현재 디렉터리를 변경 하 고 디렉터리의 표시 형식 목록이 표시 됩니다. 매크로의 끝에 *를 사용 **$ \\** 하 여 TX를 실행할 때 **dir** 에 다른 명령줄 옵션을 추가할 수 있습니다.
