...
**-On** 명령을 사용 하 여 C 드라이브에 대 한 BitLocker를 켜고 드라이브에 복구 암호를 추가 하는 방법을 보여 줍니다.
```
manage-bde –on C: -recoverypassword
```
**-On** 명령을 사용 하 여 C 드라이브에 대 한 BitLocker를 설정 하는 방법을 보여 주기 위해 드라이브에 복구 암호를 추가 하 고 드라이브 E에 복구 키를 저장 합니다.
```
manage-bde –on C: -recoverykey E:\ -recoverypassword
```
**-켜기** 명령을 사용 하 여 외부 키 보호기 (예: USB 키)를 사용 하 여 C 드라이브에 대 한 BitLocker를 설정 하 여 운영 체제 드라이브의 잠금을 해제 하는 방법을 설명 합니다. 이 메서드는 TPM이 없는 컴퓨터와 BitLocker를 사용 하는 경우에 필요 합니다.
```
manage-bde -on C: -startupkey E:\
```
**-On** 명령을 사용 하 여 데이터 드라이브 E에 대 한 BitLocker를 설정 하 고 암호 키 보호기를 추가 하는 방법을 설명 합니다. 관리 bde이이 명령을 입력 된 후에 암호를 입력 하 라는 메시지가 나타납니다.
```
manage-bde –on E: -pw
```
**-On** 명령을 사용 하 여 운영 체제 C 드라이브에 대 한 BitLocker를 설정 하 고 하드웨어 기반 암호화를 사용 하는 방법을 설명 합니다.
```
