---
title: tlntadmn
description: 텔넷 서버 서비스를 실행 하는 로컬 또는 원격 컴퓨터를 관리 하는 tlntadmn에 대 한 Windows 명령 항목입니다.
...
|        config maxconn = \<Connections >         |                                                                                                                                         최대 연결 수를 설정합니다.                                                                                                                                          |
