...
|    /fs: {FAT    |                                                                                                                                                                                                                       FAT32                                                                                                                                                                                                                        |
|  /v:\<레이블 >   |                           볼륨 레이블을 지정합니다. 생략 하면는 **/v** 명령줄 옵션을 선택 하거나 볼륨 레이블을 지정 하지 않고 사용 **형식** 서식을 완료 한 후 볼륨 레이블을 묻습니다. 볼륨 레이블을 묻는 메시지를 표시하지 않으려면 **/v:** 구문을 사용합니다. 단일 **형식** 명령을 사용 하 여 둘 이상의 디스크를 포맷 하는 경우 모든 디스크에 동일한 볼륨 레이블이 지정 됩니다.                            |
