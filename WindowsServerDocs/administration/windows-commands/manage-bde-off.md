...
ms.locfileid: "80840036"
---
# <a name="manage-bde-off"></a>manage-bde: off



드라이브를 해독 하 고 BitLocker를 해제 합니다. 암호 해독 완료 되 면 모든 키 보호기 제거 됩니다. 이 명령을 사용할 수 있는 방법을의 예 참조 [예제](#BKMK_Examples)합니다.
...
다음 예제를 사용 하는 **-오프** C 드라이브에서 BitLocker를 해제 하는 명령
```
manage-bde –off C:
```
