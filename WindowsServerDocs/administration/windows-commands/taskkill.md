---
title: taskkill
description: 하나 이상의 작업 또는 프로세스를 종료 하는 taskkill에 대 한 Windows 명령 항목입니다.
...
|     /im \<ImageName >      |                                                                                종료할 프로세스의 이미지 이름을 지정 합니다. 와일드 카드 문자 ( **\\** \*)를 사용 하 여 모든 이미지 이름을 지정할 수 있습니다.                                                                                |
...
|  사용자 이름   |         eq, ne         |                                               모든 유효한 사용자 이름 (*사용자* 또는 *도메인*\\*사용자*)                                               |
|  서비스   |         eq, ne         |                                                                 서비스 이름                                                                 |
...
* */Im 옵션에는 필터가 적용 될 때만 와일드 카드 문자 ( **\\** <em>)가 허용 됩니다 */im</em>*  .
...
시스템에 의해 시작 된 경우 프로세스를 강제로 종료 하려면 다음을 입력 합니다.
