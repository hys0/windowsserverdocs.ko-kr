...
|[/ JoinRights: {JoinOnly & #124; 전체}]|지정된 된 사용자에 할당할 권한의 유형을 지정 합니다.<br /><br />-   **Joinonly** 를 사용 하려면 관리자가 컴퓨터 계정을 다시 설정 해야 사용자가 컴퓨터를 도메인에 연결할 수 있습니다.<br />0 @no__t**full** 은 컴퓨터를 도메인에 가입 시킬 수 있는 권한을 포함 하는 사용자에 게 모든 권한을 부여 합니다.|
...
[delete](using-the-delete-autoadddevices-command.md)autoadddevices 명령을 사용 하 여 @no__t[-3 사용](using-the-get-autoadddevices-command.md)거부-autoadddevices 명령을 사용 하 여 
[거부 autoadddevices 명령을](using-the-reject-autoadddevices-command.md) 사용 하 여
