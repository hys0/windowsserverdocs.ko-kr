...
|           매개 변수           |                                                                         설명                                                                          |
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [\<드라이브 >:] [\<경로 >]<FileName> | 호출 하려는 일괄 프로그램의 이름과 위치를 지정 합니다. *FileName* 매개 변수는 필수 되며 확장명이.bat 또는.cmd 있어야 합니다. |
...
**%\*** 일괄 처리 스크립트에서 모든 인수를 참조 합니다 (예: **% 1**, **% 2**, **% 3**...).
...
위의 예제에서 **%1** 경로 다른 유효한 값으로 대체 될 수 있습니다. <strong>%~</strong>  구문에 유효한 인수가 숫자 종료 됩니다. 한정자 <strong>%~</strong> 는와 함께 **% 사용할수없습니다\*. \\**
...
-   파이프 및 리디렉션 기호 사용
    ...
    호출에는 파이프 ( **|** ) 및 리디렉션 기호 ( **<** 또는 **>** )를 사용 하지 마십시오.
-   재귀 호출 만들기
