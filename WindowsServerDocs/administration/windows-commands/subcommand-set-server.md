...
|[/ BootProgram:<Relative path>] / 아키텍처: {x86 &#124 ia64 &#124; x64}|RemoteInstall 폴더 (예: **boot\x86\pxeboot.n12**)에서 부팅 프로그램에 대 한 상대 경로를 지정 하 고 부팅 프로그램의 아키텍처를 지정 합니다.|
