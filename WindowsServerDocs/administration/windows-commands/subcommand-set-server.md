...
|[/ AnswerClients: {모든 & #124; 알려진 & #124; 없음}]|이 서버에 응답 하는 클라이언트를 지정 합니다. 이 값을 **알려진**값으로 설정 하는 경우 AD DS (Active Directory 도메인 서비스)에서 컴퓨터를 사전 준비 해야 Windows 배포 서비스 서버에서 응답을 받을 수 있습니다.|
