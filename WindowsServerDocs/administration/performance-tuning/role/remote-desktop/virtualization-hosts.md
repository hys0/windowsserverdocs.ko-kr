...
또한 "가상 데스크톱 인프라 (VDI)를 사용 하도록 볼륨을 구성 해야 합니다? 중복 제거 최적화 형식입니다. 서버 관리자를 사용 하 여 구성할 수 있습니다 (**File and Storage Services**  - &gt; **볼륨**  - &gt; **중복제거설정**) 또는 다음 Windows PowerShell을 사용 하 여 명령:

``` syntax
Enable-DedupVolume <volume> -UsageType HyperV
```

**참고**    열려 있는 파일의 데이터 중복 제거 최적화는 SMB 3.0을 통한 원격 저장소를 사용 하 여 Hyper-v를 사용 하 여 VDI 시나리오에만 지원 됩니다.
