...
결과로 나타나는 저장소 효율성은 선택한 비율에 따라 달라집니다. [이 데모](https://www.youtube.com/watch?v=-LK2ViRGbWs&t=36m55s)에서 몇 가지 예를 참조하세요.
   ...
   >[!TIP]
   > 데이터 injestion 통해 갑작스러운는 쓰기 성능이 저하에만 관찰 되는 경우 미러 부분 충분 한지 또는 패리티 미러 가속 사용 사례에 적합 하지는 나타낼 수 있습니다. 예를 들어 경우 400 MB/s에서 성능 감소를 40 MB/s 쓸, 미러 부분을 확장 하거나 3 방향 미러로 전환 합니다.
