...
2. **데이터 집합에 대 한 워크 로드의 i/o 패턴은 무엇 인가요? 내 워크 로드에 대해 어떤 성능이 필요 한가요?**  
...
![드롭다운에서 원하는 사용 유형을 선택](media/enable-dedup-via-server-manager-4.png)
...
**X 워크 로드에 대 한 데이터 집합에서 데이터 중복 제거를 실행 하려고 합니다. 지원 되나요?**  
