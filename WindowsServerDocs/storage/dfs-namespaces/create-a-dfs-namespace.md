...
> [!IMPORTANT]
> 포리스트 기능 수준이 Windows Server 2003 이상이 아닌 경우 Windows Server 2008 모드를 사용하여 도메인 기반 네임스페이스를 만들려고 하면 안 됩니다. 그렇게 하면 네임스페이스에 대한 DFS 폴더를 삭제할 수 없고 "폴더를 삭제할 수 없습니다. 이 기능을 마칠 수 없습니다."라는 오류 메시지가 나타납니다.
