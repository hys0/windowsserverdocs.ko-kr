...
| 관련 기술|[Windows Server의 ID 및 액세스](../../identity/identity-and-access.yml)<br>[Windows Server의 스토리지](../storage.yml)<br>[원격 액세스 및 서버 관리](../../remote/index.yml) |
