...
| 비용 인식 동기화 | 새로 만들기 | 사용자가 사용 한도가 있는 요금제 연결을 사용 하거나 다른 공급자의 네트워크에서 로밍 하는 동안 동기화에서 데이터 사용량이 많은 것을 방지할 수 있습니다. |
| 기본 컴퓨터 지원 | 새로 만들기 | 를 사용 하 여 폴더 리디렉션, 로밍 사용자 프로필 또는 둘 다를 사용자의 기본 컴퓨터로 제한할 수 있습니다. |
