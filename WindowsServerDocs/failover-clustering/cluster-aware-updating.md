...
-   CAU는 기업 전체에서 일관된 IT 프로세스를 도입합니다. 여러 장애 조치 (failover) 클러스터 클래스에 대해 업데이트 실행 프로필을 만든 다음 파일 공유에서 중앙에서 관리 하 여,\-비즈니스 또는 관리자의\-다른 줄로 클러스터를 관리 하더라도 IT 조직 전체의 CAU 배포에서 업데이트를 일관 되 게 적용할 수 있습니다.  
