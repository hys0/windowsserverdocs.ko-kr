...
- 저장소 공간 다이렉트를 사용 하는 경우 클러스터는 두 개의 노드 오류만 지원할 수 있습니다. 이 방법은 더는 [쿼럼 섹션 풀](../storage/storage-spaces/understand-quorum.md)
...
마법사를 실행 하며 **요약** 마법사에서 수행한 작업 보고서 보기에서 선택 하려는 경우 페이지가 나타나면 **보고서 보기**합니다. 가장 최근 보고서에 남아 합니다 <em>systemroot</em> **\\클러스터\\보고서** 이름의 폴더가 **QuorumConfiguration.mht**합니다.
