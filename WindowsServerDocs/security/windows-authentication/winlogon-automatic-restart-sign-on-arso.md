...
![잠금 화면 앱 보여 주는 스크린샷](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_LockScreen.gif)  
...
![여부 디바이스는 자동으로 로그인 마지막 대화형 사용자 Windows 업데이트 시스템이 다시 시작 된 후 지정할 수 있는 UI를 제어 하는 정책 설정를 보여 주는 스크린샷](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_SignInPolicy.gif)  
