...
ms.locfileid: "4339591"
---
# Windows Admin Center에 대한 환경 준비
...
## Windows Server 2012 및 2012 R2 준비
...
확인 [.NET Framework 4.5.2 이상을](https://docs.microsoft.com/dotnet/framework/install/on-windows-7) 컴퓨터에 이미 설치 되어 있습니다.
...
### **3단계:** PowerShell용 Hyper-V 모듈을 사용하도록 설정
...
## Microsoft Hyper-V Server 2012 R2 준비
...
### Microsoft Hyper-V Server 2012 R2를 Windows Admin Center로 관리하는 방법:
...
### **1단계:** Windows Management Framework 5.1 설치
...
### 4단계: PowerShell용 Hyper-V 모듈을 사용하도록 설정 ##
