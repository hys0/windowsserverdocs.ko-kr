---
title: 현재 Windows 관리 센터에서 아이콘 목록
description: 현재 Windows 관리 센터 sdk (프로젝트 브라 티) 아이콘 목록
...
ms.locfileid: "2074264"
---
# <a name="current-list-of-icons-in-windows-admin-center"></a>현재 Windows 관리 센터에서 아이콘 목록
