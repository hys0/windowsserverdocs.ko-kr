...
사용자는 인증서 또는 비대칭 키 쌍에 연결 된 정보에 대 한 생체 인식 또는 PIN 로그를 사용 하 여, 장치에 로그온 합니다. Id 공급자 (IDPs)는 사용자의 공개 키를 Idps에 매핑하여 사용자의 유효성을 검사 하 고 OTP (일회용 암호), 휴대폰 또는 다른 알림 메커니즘을 통해 정보에 대 한 로그를 제공 합니다.  
