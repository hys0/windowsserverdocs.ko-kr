...
-   [시나리오 개요](../../ad-fs/operations/Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md#BKMK_2) -Active Directory Federation Services (AD FS)를 사용 하 여 사용자의 그룹 구성원 자격에 따라 MFA (다단계 인증)를 사용 하는 시나리오에 대 한 설명입니다.
    ...
    이 시나리오를 구성 하 고 확인 하기 위한 자세한 단계별 연습 지침은 [ 연습 가이드: 중요 한 응용 프로그램](../../ad-fs/operations/Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)에 대 한 추가 Multi-Factor Authentication로 위험 관리
...
-   전역 인증 정책-IT 관리자가 보호 된 리소스에 액세스 하는 네트워크 위치에 따라 사용자를 인증 하는 데 사용 되는 인증 방법을 선택할 수 있는 중앙 관리 기능입니다. 이를 통해 관리자는 다음을 수행할 수 있습니다.
    ...
    -   연속된 두 번째 단계 인증에 장치 인증 사용. 이는 리소스에 액세스 하는 데 사용 되는 등록 된 장치에 사용자 id를 연결 하므로 보호 된 리소스에 액세스 하기 전에 보다 안전한 복합 id 확인을 제공 합니다.
        ...
        > [!NOTE]
        > 장치 개체, 장치 등록 서비스, Workplace Join 및 장치를 원활한 두 번째 단계 인증 및 SSO로 연결 하는 방법에 대 한 자세한 내용은 [모든 장치에서 작업 공간에 연결 SSO 및 원활한 두 번째 단계 인증을 참조 하세요. 응용 프로그램](Join-to-Workplace-from-Any-Device-for-SSO-and-Seamless-Second-Factor-Authentication-Across-Company-Applications.md).
...
-   장치 인증 사용 여부. 자세한 내용은 [SSO 및 원활한 두 번째 단계 인증에서 회사 응용 프로그램에 대 한 모든 장치에서 작업 공간 가입](../../ad-fs/operations/Join-to-Workplace-from-Any-Device-for-SSO-and-Seamless-Second-Factor-Authentication-Across-Company-Applications.md)합니다.
...
> [!NOTE]
> 장치 개체, 장치 등록 서비스, Workplace Join 및 장치를 원활한 두 번째 단계 인증 및 SSO로 연결 하는 방법에 대 한 자세한 내용은 [모든 장치에서 작업 공간에 연결 SSO 및 원활한 두 번째 단계 인증을 참조 하세요. 응용 프로그램](../../ad-fs/operations/Join-to-Workplace-from-Any-Device-for-SSO-and-Seamless-Second-Factor-Authentication-Across-Company-Applications.md).
...
이 시나리오를 설정 하 고 확인 하는 단계별 지침은 [ 연습 가이드: 중요 한 응용 프로그램](../../ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)에 대 한 추가 Multi-Factor Authentication로 위험 관리 이 연습의 단계를 완료 하려면 랩 환경을 설정 하 고 [Windows Server 2012 r 2에서 AD FS에 대 한 랩 환경 설정](../../ad-fs/deployment/Set-up-the-lab-environment-for-AD-FS-in-Windows-Server-2012-R2.md)의 단계를 수행 해야 합니다.

AD FS에서 MFA를 사용 하도록 설정 하는 다른 시나리오는 다음과 같습니다.

-   엑스트라넷에서 액세스를 요청한 경우 MFA를 사용합니다. @No__t-0 연습 가이드의 "MFA 정책 설정" 섹션에 나와 있는 코드를 수정할 수 있습니다. 다음을 사용 하 여 중요 한 응용 프로그램에 대 한 추가 Multi-Factor Authentication를 사용 하 여 위험 관리 @ no__t-0:

    ```
    'c:[type == "https://schemas.microsoft.com/ws/2012/01/insidecorporatenetwork", value == "false"] => issue(type="https://schemas.microsoft.com/ws/2008/06/identity/claims/authenticationmethod", value = "https://schemas.microsoft.com/claims/multipleauthn" );'
    ```

-   작업 공간에 연결되지 않은 장치에서 액세스를 요청한 경우 MFA를 사용합니다.  @No__t-0 연습 가이드의 "MFA 정책 설정" 섹션에 나와 있는 코드를 수정할 수 있습니다. 다음을 사용 하 여 중요 한 응용 프로그램에 대 한 추가 Multi-Factor Authentication를 사용 하 여 위험 관리 @ no__t-0:
...
-   작업 공간에 연결되어 있지만 해당 사용자에 등록되지 않은 장치의 사용자가 액세스하는 경우 MFA를 사용합니다. @No__t-0 연습 가이드의 "MFA 정책 설정" 섹션에 나와 있는 코드를 수정할 수 있습니다. 다음을 사용 하 여 중요 한 응용 프로그램에 대 한 추가 Multi-Factor Authentication를 사용 하 여 위험 관리 @ no__t-0:
...
[연습 가이드: 중요 한 응용 프로그램에 대 한 추가 Multi-Factor Authentication를 사용 하 여 위험 관리 @ no__t-0 @ no__t-1[Windows Server 2012 r 2의 AD FS에 대 한 랩 환경 설정](../../ad-fs/deployment/Set-up-the-lab-environment-for-AD-FS-in-Windows-Server-2012-R2.md)
