...
|**정책**|**정책 규칙**|
| --- | --- |  
|엑스트라넷 액세스 MFA 요구<br /><br />모든 사용자 수|**규칙 #1**<br /><br />**엑스트라넷**<br /><br />MFA를 사용 하 고<br /><br />허용<br /><br />**규칙 # 2**<br /><br />**인트라넷**<br /><br />허용|  
...
2.  이름과 설명을 입력 합니다.  예를 들어 다음과 같은 가치를 제공해야 합니다.  인증 된 장치를 사용 하는 사용자를 허용 합니다.  
...
2.  이름과 설명을 입력 합니다.  예를 들어 다음과 같은 가치를 제공해야 합니다.  특정 클레임의 사용자를 허용 합니다.  
...
2.  이름과 설명을 입력 합니다.  예를 들어 다음과 같은 가치를 제공해야 합니다.  인증 된 장치를 사용 하지만 관리 되지 않는 사용자를 허용 합니다.  
...
2.  이름과 설명을 입력 합니다.  예를 들어 다음과 같은 가치를 제공해야 합니다.  특정 클레임 및 특정 그룹의 사용자를 허용 합니다.  
