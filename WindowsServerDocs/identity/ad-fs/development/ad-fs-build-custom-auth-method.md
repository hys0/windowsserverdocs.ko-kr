...
1.  먼저, 글로벌 정책에서 공급자를 사용 하도록 설정:
    ...
    > [!NOTE]
    > AdditionalAuthenticationProvider 매개 변수에 대해 제공 된 값에서 "Name" 속성 위에 등록 AdfsAuthenticationProvider cmdlet에서 "Name" 매개 변수에 대해 제공 된 값에 해당 하는 참고 Get-AdfsAuthenticationProvider cmdlet 출력입니다. 
    > <P></P>

    
    예:`PS C:\>Set-AdfsGlobalAuthenticationPolicy –AdditionalAuthenticationProvider “MyMFAAdapter”`
