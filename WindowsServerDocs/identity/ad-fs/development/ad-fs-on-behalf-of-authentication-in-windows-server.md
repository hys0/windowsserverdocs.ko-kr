...
title: On-Behalf-Of (OBO) OAuth를 사용 하 여 AD fs 2016 이상의 버전을 사용 하 여 다중 계층 응용 프로그램 빌드
description: ''
author: billmath
ms.author: billmath
manager: mtillman
...
이 연습을에서-대리 (OBO) 인증 이상 Windows Server 2016 TP5에서 AD FS를 사용 하 여 구현 하기 위한 지침을 제공 합니다. 읽으십시오 OBO 인증에 자세히 알아보려면 [개발자를 위한 AD FS 시나리오](../../ad-fs/overview/AD-FS-Scenarios-for-Developers.md)
...
WebAPI-영문-DotNet.sln 솔루션을 열면 즉시 알게 됩니다 솔루션에 프로젝트가 있다고
