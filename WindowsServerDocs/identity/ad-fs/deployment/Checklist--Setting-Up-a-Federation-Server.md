...
ms.locfileid: "80854966"
---
# <a name="checklist-setting-up-a-federation-server"></a>검사 목록: 페더레이션 서버 설정

이 검사 목록에는 Active Directory Federation Services \(AD FS\)에서 페더레이션 서버 역할에 대해 Windows Server&reg; 2012를 실행 하는 서버를 준비 하는 데 필요한 배포 작업이 포함 되어 있습니다.  
