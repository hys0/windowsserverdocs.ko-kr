...
##### [파일 서버에 정보 보존 구현 배포 데모 단계](solution-guides/Deploy-Implementing-Retention-of-Information-on-File-Servers--Demonstration-Steps-.md)
#### [포리스트에 클레임 배포](solution-guides/Deploy-Claims-Across-forests.md)
##### [포리스트에 클레임 배포(데모 단계)](solution-guides/Deploy-Claims-Across-forests--Demonstration-Steps-.md)
...
#### [Active Directory 도메인 서비스 개요](ad-ds/get-started/virtual-dc/active-directory-domain-services-overview.md)
...
##### [AD DS(Active Directory 도메인 서비스) 가상화 소개(수준 100)](ad-ds/Introduction-to-active-directory-Domain-Services-AD-DS-Virtualization-Level-100.md)
...
###### [Active Directory Azure Vm에서 실행](ad-ds/deploy/virtual-dc/adds-on-azure-vm.md)
...
##### [응용 프로그램 공급업체를 위한 가상화된 도메인 컨트롤러 복제 테스트 지침](ad-ds/reference/virtual-dc/Virtualized-Domain-Controller-Cloning-Test-Guidance-for-Application-Vendors.md)
...
###### [AD DS 소유자 역할에 DNS 할당](ad-ds/deploy/assigning-the-DNS-for-AD-DS-Owner-Role.md)
...
####### [기본 컨테이너 및 OU의 관리 위임](ad-ds/plan/delegating-Administration-of-Default-Containers-and-OUs.md)
####### [OU의 사용자 계정 및 리소스 OU 관리 위임](ad-ds/plan/delegating-Administration-of-Account-OUs-and-Resource-OUs.md)
...
#### [AD DS에 대한 고급 기능 사용 설정](ad-ds/plan/Enabling-Advanced-Features-for-AD-DS.md)
...
### [AD DS 개발](ad-ds/deploy/AD-DS-Deployment.md)
...
#### [Active Directory 도메인 서비스 설치](ad-ds/deploy/Install-active-directory-Domain-Services--Level-100-.md)
...
##### [Windows Server 2012 Active Directory 읽기 전용 도메인 컨트롤러(RODC) 설치](ad-ds/deploy/RODC/Install-a-Windows-Server-2012-active-directory-Read-Only-Domain-Controller--RODC---Level-200-.md)
...
#### [Adprep.exe에 의한 변경](ad-ds/deploy/adprep/changes-Made-by-Adprep.md)
...
##### [손상 징후에 대한 Active Directory 모니터링](ad-ds/plan/security-best-practices/Monitoring-active-directory-for-Signs-of-compromise.md)
...
##### [부록 G: Active Directory에서 Administrators 그룹 보안](ad-ds/plan/security-best-practices/appendix-G--Securing-Administrators-Groups-in-active-directory.md)
...
#### [Active Directory 도메인 서비스 구성 요소 업데이트](ad-ds/manage/component-updates/active-directory-Domain-Services-component-Updates.md)
...
####### [Active Directory 사용자에게 클레임 인식 응용 프로그램 및 서비스에 대한 액세스 제공](ad-fs/design/Provide-Your-active-directory-Users-Access-to-Your-Claims-Aware-Applications-and-Services.md)
####### [Active Directory 사용자에게 다른 조직의 응용 프로그램 및 서비스에 대한 액세스 제공](ad-fs/design/Provide-Your-active-directory-Users-Access-to-the-Applications-and-Services-of-Other-Organizations.md)
####### [다른 조직의 사용자에게 클레임 인식 응용 프로그램 및 서비스에 대한 액세스 제공](ad-fs/design/Provide-Users-in-Another-Organization-Access-to-Your-Claims-Aware-Applications-and-Services.md)
...
####### [AD FS와 함께 AD DS 클레임 사용](ad-fs/design/Using-AD-DS-Claims-with-AD-FS.md)
...
####### [ID 위임을 사용하는 시기](ad-fs/design/When-to-Use-Identity-delegation.md)
...
######## [리소스 파트너의 페더레이션 응용 프로그램 전략 결정](ad-fs/design/Determine-Your-Federated-Application-Strategy-in-the-Resource-Partner.md)
...
#### [온-프레미스 장치 기반 조건부 액세스 계획](ad-fs/deployment/Plan-Device-based-Conditional-Access-on-Premises.md)
...
###### [도메인에 컴퓨터 가입](ad-fs/deployment/Join-a-computer-to-a-Domain.md)
...
###### [사용자 지정 규칙을 사용하여 클레임을 보내도록 규칙 만들기](ad-fs/operations/create-a-Rule-to-Send-Claims-Using-a-Custom-Rule.md)
...
###### [페더레이션 서버 팜에 대해 수동으로 서비스 계정 구성](ad-fs/deployment/Manually-Configure-a-Service-Account-for-a-Federation-Server-Farm.md)
...
#####[Windows Server 2012 R2로의 AD FS 마이그레이션 확인](ad-fs/deployment/verify-ad-fs-migration.md)
...
######[AD FS 2.0 단독 실행형 또는 단일 노드 팜 서버 마이그레이션](ad-fs/deployment/migrate-ad-fs-stand-alone-server.md)
...
#### [AD FS를 사용하는 단일 페이지 응용 프로그램](ad-fs/development/Single-Page-Application-with-AD-FS.md)
#### [AD FS를 통한 OAuth 공요 클라이언트를 사용한 기본 클라이언트 응용 프로그램 빌드](ad-fs/development/native-client-with-ad-fs.md)
...
#### [인증서 인증을 위한 대체 호스트 이름 바인딩에 대한 AD FS 지원](ad-fs/operations/AD-FS-support-for-alternate-hostname-binding-for-certificate-authentication.md)
...
#### [온-프레미스 장치 기반 조건부 액세스 구성](ad-fs/operations/Configure-Device-based-Conditional-Access-on-Premises.md)
#### [WIA를 지원하지 않는 장치에 대한 인트라넷 폼 기반 인증 구성](ad-fs/operations/Configure-intranet-forms-based-authentication-for-devices-that-do-not-support-WIA.md)
...
#### [비관리자 사용자에게 AD FS Powershell Commandlet 액세스 위임](ad-fs/operations/delegate-ad-fs-pshell-access.md)
#### [AD FS의 장치 인증 컨트롤](ad-fs/operations/device-authentication-controls-in-AD-FS.md)

#### [SAML 2.0과의 향상된 상호 운용성](ad-fs/operations/Improved-interoperability-with-SAML-2.0.md)
#### [회사 응용 프로그램 전반에 SSO 및 연속된 두 번째 단계 인증을 위한 모든 디바이스의 작업 공간 연결](ad-fs/operations/Join-to-Workplace-from-Any-Device-for-SSO-and-Seamless-Second-Factor-Authentication-Across-company-Applications.md)
#### [추가 Multi-Factor Authentication을 사용하여 중요한 응용 프로그램에 대한 위험 관리](ad-fs/operations/Manage-Risk-with-additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)
...
#### [연습 가이드: 추가 다단계 인증을 사용하여 중요한 응용 프로그램에 대한 위험 관리](ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-additional-Multi-Factor-Authentication-for-Sensitive-Applications.md)
#### [연습 가이드: 조건부 액세스 제어를 사용한 위험 관리](ad-fs/operations/Walkthrough-Guide--Manage-Risk-with-Conditional-Access-Control.md)
#### [연습: Windows 장치를 사용하여 작업 공간 연결](ad-fs/operations/Walkthrough--Workplace-Join-with-a-Windows-Device.md)
#### [연습: iOS 장치를 사용하는 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-with-an-iOS-Device.md)
#### [연습: Android 디바이스를 사용하는 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-to-an-Android-device.md)
...
#### [끝점](ad-fs/troubleshooting/ad-fs-tshoot-endpoints.md)
...
#### [SignOn 시작](ad-fs/troubleshooting/ad-fs-tshoot-initiatedsignon.md)
#### [통합 Windows 인증](ad-fs/troubleshooting/ad-fs-tshoot-iwa.md)
#### [로깅](ad-fs/troubleshooting/ad-fs-tshoot-logging.md)
#### [루프](ad-fs/troubleshooting/ad-fs-tshoot-loop.md)
#### [SQL](ad-fs/troubleshooting/ad-fs-tshoot-sql.md)



### [AD FS 기술 참고자료](ad-fs/AD-FS-Technical-Reference.md)
...
#### [Windows Server AD FS의 향상된 감사 기능](ad-fs/technical-reference/auditing-enhancements-to-ad-fs-in-windows-server.md)
...
#### [AD FS 비밀번호 공격 보호](ad-fs/technical-reference/ad-fs-password-protection.md)
### [AD FS 2016 FAQ](ad-fs/overview/AD-FS-FAQ.md)

## [권한 있는 액세스 보안](securing-privileged-access/securing-privileged-access.md)
### [Privileged Access Workstation](securing-privileged-access/privileged-access-workstations.md)
...
#### [소프트웨어 제한 정책에 대한 허용-거부 목록 및 응용 프로그램 인벤토리 확인](software-restriction-policies/determine-allow-deny-list-and-application-inventory-for-software-restriction-policies.md)
#### [소프트웨어 제한 정책 규칙 사용](software-restriction-policies/work-with-software-restriction-policies-rules.md)
### [소프트웨어 제한 정책을 사용하여 메일 바이러스로부터 컴퓨터 보호](software-restriction-policies/use-software-restriction-policies-to-help-protect-your-computer-against-an-email-virus.md)
