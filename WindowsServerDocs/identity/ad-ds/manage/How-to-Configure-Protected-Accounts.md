...
-   [원격 데스크톱에 대 한 제한 된 관리자 모드](http://blogs.technet.com/b/kfalde/archive/2013/08/14/restricted-admin-mode-for-rdp-in-windows-8-1-2012-r2.aspx)
...
-   Kerberos 사전 인증에서 RC4 거부: 구성할 수 없습니다.
    ...
    > [!NOTE]
    > [지원되는 암호화 형식의 구성을 변경](http://blogs.msdn.com/b/openspecification/archive/2011/05/31/windows-configurations-for-kerberos-supported-encryption-type.aspx)할 수 있지만 대상 환경에서 테스트하지 않은 상태에서는 컴퓨터 계정에 대해 이러한 설정을 변경하지 않는 것이 좋습니다.
