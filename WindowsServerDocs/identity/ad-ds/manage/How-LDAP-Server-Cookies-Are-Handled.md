...
250MB 이상의 풀에서도 이벤트 2899가 계속 표시되면 많은 클라이언트에서 매우 자주 쿼리되어 매우 많은 개체가 반환되는 것일 수 있습니다. [Active Directory 데이터 수집기 집합](http://blogs.technet.com/b/askds/archive/2010/06/08/son-of-spa-ad-data-collector-sets-in-win2008-and-beyond.aspx) 을 사용하여 수집할 수 있는 데이터를 사용하면 LDAP 서버를 사용 중 상태로 유지하는 반복적인 페이징된 쿼리를 찾을 수 있습니다. 이러한 쿼리는 사용 된 페이지 크기와 일치 하는 많은 "반환 된 항목"과 함께 표시 됩니다.  
