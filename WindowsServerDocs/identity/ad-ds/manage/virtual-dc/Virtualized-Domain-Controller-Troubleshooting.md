...
|**정보 및 해결**|응용 프로그램 및 시스템 이벤트 로그를 검사하세요. 권한 업데이트를 차단할 수 있는 타사 애플리케이션을 조사하세요.|  
...
|참고 사항 및 해결 방법|디렉터리 서비스 로그와 dcpromo.log에서 세부 정보를 검사하세요. 응용 프로그램 및 시스템 이벤트 로그를 검사하세요. 권한 업데이트를 차단할 수 있는 타사 애플리케이션을 조사하세요.|  
...
|참고 사항 및 해결 방법|응용 프로그램 및 시스템 이벤트 로그를 검사하세요. 권한 업데이트를 차단할 수 있는 타사 애플리케이션을 조사하세요.|  
