...
## <a name="demotion-and-role-removal-with-powershell"></a>PowerShell 사용 하 여 수준 내리기 및 역할 제거
...
![역할 및 기능 마법사-확인 대화 상자 제거](media/Demoting-Domain-Controllers-and-Domains--Level-200-/ADDS_RRW_TR_RemoveFeatures.png)  
