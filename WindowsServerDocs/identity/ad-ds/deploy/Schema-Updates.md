...
title: Windows Server의 스키마 업데이트
description: 운영 체제 버전별 adprep에의 한 스키마 변경 내용
...
ms.locfileid: "71369612"
---
# <a name="windows-server-active-directory-schema-updates"></a>Windows Server Active Directory 스키마 업데이트

>적용 대상: Windows Server

이 항목에서는 Adprep.exe에서 수행 하는 변경 내용이 포함 된 LDF 파일을 나열 합니다.  

Windows Server 2019에 포함 된 LDF 파일은 다음과 같습니다.

-   [Sch88](#BKMK_Sch88)

Windows Server 2016에 포함 된 LDF 파일은 다음과 같습니다.
...
Windows Server 2012 r 2에 포함 된 LDF 파일은 다음과 같습니다.  
...
Windows Server 2012에 포함 된 LDF 파일은 다음과 같습니다.  
...
## <a name="schema-update-in-windows-server-2019"></a>Windows Server 2019의 스키마 업데이트
...
## <a name="schema-updates-in-windows-server-2016"></a>Windows Server 2016의 스키마 업데이트
...
## <a name="BKMK_SchemaUpdates2012R2"></a>Windows Server 2012 r 2의 스키마 업데이트  
...
## <a name="BKMK_SchemaUpdates2012"></a>Windows Server 2012의 스키마 업데이트  
