...
title: Windows Server에서 스키마 업데이트
description: 운영 체제 버전에서 adprep에 대 한 스키마 변경
...
ms.locfileid: "59822664"
---
# <a name="windows-server-active-directory-schema-updates"></a>Windows Server Active Directory 스키마 업데이트

>적용 대상: Windows Server

이 항목에서는 Adprep.exe 변경 내용에 포함 된 LDF 파일을 나열 합니다.  

Windows Server 2019에 포함 된 LDF 파일입니다.

-   [Sch88.ldf](#BKMK_Sch88)

다음은 Windows Server 2016에 포함 된 LDF 파일입니다.
...
다음은 Windows Server 2012 R2에 포함 된 LDF 파일입니다.  
...
다음은 Windows Server 2012에 포함 된 LDF 파일입니다.  
...
## <a name="schema-update-in-windows-server-2019"></a>Windows Server 2019 스키마 업데이트
...
## <a name="schema-updates-in-windows-server-2016"></a>Windows Server 2016의에서 스키마 업데이트
...
## <a name="BKMK_SchemaUpdates2012R2"></a>Windows Server 2012 R2의 스키마 업데이트  
...
## <a name="BKMK_SchemaUpdates2012"></a>Windows Server 2012의에서 스키마 업데이트  
