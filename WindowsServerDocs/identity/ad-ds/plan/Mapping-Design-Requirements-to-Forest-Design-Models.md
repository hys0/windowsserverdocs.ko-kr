...
|[시나리오 2: 조직 포리스트 또는 도메인을 사용 하 여 서비스 자율성](#BKMK_2)|아니요|아니요|해당 없음|아니요|예|  
|[시나리오 3: 서비스 격리를 위해 조직 포리스트 또는 리소스 포리스트 사용](#BKMK_3)|아니요|아니요|해당 없음|예|해당 없음|  
|[시나리오 4: 데이터 격리를 위해 조직 포리스트 또는 제한 된 액세스 포리스트 사용](#BKMK_4)|해당 없음|예|해당 없음|해당 없음|해당 없음|  
|[시나리오 5: 조직 포리스트 사용 또는 제한 된 연결에 대 한 방화벽 다시 구성](#BKMK_5)|예|아니요|해당 없음|아니요|아니요|  
|[시나리오 6: 조직 포리스트 또는 도메인을 사용 하 고 제한 된 연결로 서비스 자율성을 위한 방화벽 다시 구성](#BKMK_6)|예|아니요|해당 없음|아니요|예|  
|[시나리오 7: 리소스 포리스트를 사용 하 고 제한 된 연결로 서비스 격리를 위해 방화벽 다시 구성](#BKMK_7)|예|아니요|해당 없음|예|해당 없음|  

## <a name="BKMK_1"></a>시나리오 1: 데이터 자율성을 위해 기존 포리스트 조인  
...
## <a name="BKMK_6"></a>시나리오 6: 조직 포리스트 또는 도메인을 사용 하 고 제한 된 연결로 서비스 자율성을 위한 방화벽 다시 구성  
...
## <a name="BKMK_7"></a>시나리오 7: 리소스 포리스트를 사용 하 고 제한 된 연결로 서비스 격리를 위해 방화벽 다시 구성  
