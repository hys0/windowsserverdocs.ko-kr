...
이러한 단점을 해결 하기 위해 수행할 수 있는 단계에 대 한 자세한 내용은 연결 되지 않은 네임 스페이스 만들기 ([https://go.microsoft.com/fwlink/?LinkId=106638](https://go.microsoft.com/fwlink/?LinkId=106638))를 참조 하세요.  
