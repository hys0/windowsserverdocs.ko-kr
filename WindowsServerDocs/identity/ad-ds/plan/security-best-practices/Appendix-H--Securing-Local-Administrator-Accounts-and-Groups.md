...
5.  **명령 프롬프트** 창에서 **net use \\\\<Server Name>\c $/User:<Server Name>\administrator**를 입력 합니다. 여기서 <Server Name>는 네트워크를 통해 액세스 하려는 구성원 서버 또는 워크스테이션의 이름입니다.  
