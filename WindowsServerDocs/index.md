...
<div class="container">
<h1>Windows Server 설명서</h1>
<h3>Windows Server는 작업 그룹에서 데이터 센터까지 애플리케이션, 네트워크, 웹 서비스가 연결된 인프라를 구축하기 위한 플랫폼입니다.</h3>
<p> </p>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Windows Server 2019로 업그레이드</h2>
                                            <p>Windows Server Upgrade Center에서 Windows Server 업그레이드에 대한 단계별 지침을 확인하세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Windows Admin Center를 사용하여 Windows Server 2012 및 최신 버전을 관리하세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>하이퍼 컨버지드 인프라</h2>
                                            <p>소프트웨어 정의 컴퓨팅, 스토리지 및 네트워킹을 클러스터 하나에 통합하세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>여기서 Windows Server 2016을 시작하세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>서비스 종료:<br> Windows Server 2008 R2 및 Windows Server 2008</h2>
                                            <p>연장된 지원이 2020년 1월 14일에 종료됩니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>ID | 액세스</h2>
                                            <p>업계의 검증을 마친 Active Directory로 액세스 보안을 제어하여 해커 및 ID 공격으로부터 회사 자산을 보호하세요.</p>
<table>
     <tr>
       ...
       <hr width="80%">
        ...
        <td style="vertical-align: top;">
            <h4><u>최고 조회수</u></h4>
            <ol>
            <li>1. <a href="https://docs.microsoft.com/windows-server/identity/securing-privileged-access/privileged-access-workstations">Privileged Access Workstation</a></li>
       <hr width="80%">
            <li>2. <a href="https://docs.microsoft.com/windows-server/identity/securing-privileged-access/securing-privileged-access-reference-material">권한 있는 액세스 보안 참고 자료</a></li>
       <hr width="80%">
            <li>3. <a href="https://docs.microsoft.com/windows-server/identity/solution-guides/dynamic-access-control--scenario-overview">동적 액세스 제어: 시나리오 개요</a></li>
            </ol>
        </td>
    </tr>
</table></a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>장애 조치(failover) 클러스터링</h2> 
                                            <p>장애 조치(failover) 클러스터링을 사용하여 개별 서버를 그룹으로 결합하면 중요 비즈니스용 앱과 서비스를 호스트하는 시스템의 내결함성 및 가용성을 높일 수 있습니다.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Management</h2>
                                            <p>Windows Server 시스템 및 환경을 관리하고, 하드웨어 및 소프트웨어 인벤토리 정보를 수집하고, 서버를 튜닝하여 성능을 높이고, 관리 업무를 자동화하여 효율성을 높일 수 있습니다.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>네트워킹</h2>
                                            <p><a href="https://docs.microsoft.com/windows-server/networking/dns/dns-top">DNS</a>, <a href="https://docs.microsoft.com/windows-server/networking/technologies/dhcp/dhcp-top">DHCP</a> 같은 기초 기술을 사용하여 컴퓨터와 시스템을 연결하거나 <a href="https://docs.microsoft.com/windows-server/networking/sdn/software-defined-networking">소프트웨어 정의 네트워킹</a>으로 연결을 가상화하여 서비스의 보안, 성능, 품질 및 가용성을 개선하세요.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>리모컨</h2>
                                            <p>원격 데스크톱 서비스, 원격 액세스, 원격 서버 관리 도구를 비롯한 기술을 사용하여 언제, 어디서나 컴퓨터 및 디바이스에 원격으로 액세스하고 제어하여 앤터프라이즈 가용성을 확장하세요.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>보안 | 보증</h2> 
                                            <p>Shielded Virtual Machines, Device Guard, Credential Guard, Windows Defender 등의 기술을 사용하여 클라우드에서 VM으로써 Windows Server를 실행하는 데이터 센터를 보호하고, 공격자가 자격 증명을 손상시키고, 맬웨어를 시작하고, 네트워크에서 숨지 못하게 차단하세요.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>저장 공간</h2>
                                            <p>소프트웨어 정의 스토리지를 사용하는 하이퍼 컨버지드 인프라, 스토리지 마이그레이션 서비스 및 기타 기술을 포함하여 수페타바이트로 확장 가능한 복원력 있고 경제적인 고성능 스토리지 옵션을 활용하세요.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>문제 해결</h2>
                                            <p>가장 많이 사용되는 몇 가지 Windows Server 기술 및 기능의 문제 해결 방법을 알아보세요.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>가상화</h2>
                                             <p>Windows Server 가상화의 기반이 되는 Microsoft Hyper-V는 컨테이너, 롤링 클러스터 업그레이드, 보호된 VM 및 기타 향상된 보안 기능을 포함하여 최신 앱과 클라우드 인프라를 위한 컴퓨팅 가상화를 제공합니다.</p>
<table>
     <tr>
        <td style="vertical-align: top;">
            <h4><u>최고 등급</u></h4>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Windows Server 2008 및<br> Windows Server 2008 R2</h3>
                                            <p></p>
                                            </div>
                                    </div>
                                </div>
