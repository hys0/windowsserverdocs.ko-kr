...
| `(pattern)` |                         "Pattern"과 일치 하 고 일치 항목을 기억 합니다.<br />리터럴 문자 `(` 및 `)` (괄호)를 찾으려면 `\(` 또는 `\)`을 사용 합니다.                         |                                                                 &nbsp;                                                                  |
|   `x | y `  |                                                                               X 또는 y와 일치 합니다.                                                          |
|   `{n} `    |                                                          정확히 n 번 일치 \(n is @ no__t-1 부정 정수 @ no__t-2입니다.                                                           |               `/o{2}/ does not match the "o" in "Bob," but matches the first two instances of the letter o in "foooood."`               |
|   `{n,}`    |                                                          는 적어도 n 번 일치 \(n은 @ no__t-1 부정 정수 @ no__t-2입니다.                                                          | `/o{2,}/ does not match the "o" in "Bob" but matches all of the instances of the letter o in "foooood." /o{1,}/ is equivalent to /o+/.` |
|   `{n,m}`   |                                                -0m과 n 번 이상 일치 하는 항목 \(m 및 n은 @ no__t-1 음의 정수 @ no__t-2가 아닙니다.                                                |                               `/o{1,3}/ matches the first three instances of the letter o in "fooooood."`                               |
|   `[xyz]`   |                                                       -0a 문자 집합 @ no__t-1 @no__t 포함 된 문자 중 하 나와 일치 합니다.                                                        |                                                  `/[abc]/ matches the "a" in "plain."`                                                  |
|  `[^xyz]`   |                                                  -0a 부정 문자 집합 @ no__t-1 @no__t 포함 되지 않은 모든 문자를 찾습니다.                                                  |                                                 `/[^abc]/ matches the "p" in "plain."`                                                  |
|    `\b`     |                                                              단어 경계 \( (예: 공백 @ no__t-1)을 찾습니다.                                                               |                                              `/ea*r\b/ matches the "er" in "never early."`                                              |
|    `\B`     |                                                                         단어가 아닌 경계와 일치 합니다.                                                                          |                                             `/ea*r\B/ matches the "ear" in "never early."`                                              |
|    `\d`     |                                                       0에서 9 사이의 숫자에 해당 하 \(과 일치 하는 숫자 문자를 찾습니다.                                                        |                                                                 &nbsp;                                                                  |
|    `\D`     |                                                           @No__t-1 @ no__t-2에 해당 하는 nondigit 문자 \(과 일치 합니다.                                                           |                                                                 &nbsp;                                                                  |
|    `\f`     |                                                                        양식 피드 문자를 찾습니다.                                                                        |                                                                 &nbsp;                                                                  |
|    `\n`     |                                                                        줄 바꿈 문자를 찾습니다.                                                                        |                                                                 &nbsp;                                                                  |
|    `\r`     |                                                                     캐리지 리턴 문자를 찾습니다.                                                                     |                                                                 &nbsp;                                                                  |
|    `\s`     |                                   공백, 탭 및 양식 피드 \(과 일치 하는 공백 문자 (`[ \f\n\r\t\v]` @ no__t-2)와 일치 합니다.                                   |                                                                 &nbsp;                                                                  |
|    `\S`     |                                                  @No__t-1 @ no__t-2에 해당 하는 \(과 일치 하는 공백이 아닌 문자를 찾습니다.                                                   |                                                                 &nbsp;                                                                  |
|    `\t`     |                                                                           탭 문자를 찾습니다.                                                                           |                                                                 &nbsp;                                                                  |
|    `\v`     |                                                                      세로 탭 문자를 찾습니다.                                                                       |                                                                 &nbsp;                                                                  |
|    `\w`     |                                              @No__t-1 @ no__t-2와 동일한 밑줄 \(을 포함 하 여 단어 문자를 찾습니다.                                              |                                                                 &nbsp;                                                                  |
|    `\W`     |                                           @No__t-2 @ no__t-3에 해당 하 \(과 동일한 밑줄을 제외 하 고 @ no__t-0이 아닌 모든 단어 문자를 찾습니다.                                           |                                                                 &nbsp;                                                                  |
|   `\num`    | @No__t 기억 된 일치 항목을 참조 합니다.-0 @ no__t-1. 여기서 num은 양의 정수 @ no__t-2입니다.  이 옵션은 특성 조작을 구성할 때 **바꾸기** 텍스트 상자 에서만 사용할 수 있습니다. |                                       `\1`은 기억 된 첫 번째 일치 항목에 저장 된 항목을 바꿉니다.                                       |
|   `/n/ `    |                      -0 @ no__t-1 @no__t 정규식에 ASCII 코드를 삽입할 수 있습니다. 여기서 n은 8 진수, 16 진수 또는 10 진수 이스케이프 값 @ no__t-2입니다.                       |                                                                 &nbsp;                                                                  |
...
인터넷 서비스 @no__t 공급자가 연결 요청을 조직 NPS로 라우팅하는 아웃소싱 전화 접속 시나리오에서 ISP RADIUS 프록시에는 인증 요청을 라우팅하는 영역 이름이 필요할 수 있습니다 (no__t). 그러나 NPS는 사용자 이름의 영역 이름 부분을 인식 하지 못할 수 있습니다. 따라서 NPS를 조직에 전달 하기 전에 ISP RADIUS 프록시를 통해 영역 이름이 제거 되어야 합니다.

- Find: @microsoft @ no__t-1com

- 바꿀 대상:

**<em>@No__t-2</em> 를 바꿉니다 _._**
...
<strong>*사용자* 를 *user@specific_domain</strong> 으로 바꾸려면*
