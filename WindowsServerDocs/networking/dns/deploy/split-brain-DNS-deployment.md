...
레코드는 내부 영역 범위에서 <strong>www.career.contoso.com</strong> 추가 됩니다 10.0.0.39 개인 IP; 인 IP 주소와 기본 영역 범위에서 동일한 레코드를 <strong>www.career.contoso.com</strong>, 65.55.39.10 IP 주소와 함께 추가 됩니다.
...
https://www.microsoft.com 와 같이 Contoso DNS 서버에 대해 신뢰할 수 없는 쿼리가 수신 되 면 DNS 서버의 정책에 대해 이름 확인 요청이 평가 됩니다. 
...
그런 다음 DNS 서버는 인터넷에서 https://www.microsoft.com 에 대 한 답변을 가져오기 위해 재귀를 수행 하 고 응답을 로컬로 캐시 합니다. 
