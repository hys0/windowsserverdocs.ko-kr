...
ms.locfileid: "9150853"
---
# Windows Server 2016 정품 인증
...
>[!NOTE]
>**참고:**  업데이트는 이러한 최신 클라이언트의 정품 인증을 지원 하도록 KMS 서버가 필요할 수 있습니다. 활성화 오류가 발생하면 이 테이블에 나열된 적합한 업데이트가 있는지 확인합니다.
...
>- Windows 10 및 Windows Server 2016 이상의 클라이언트 또는 서버 운영 체제를 실행하는 클라이언트의 정품 인증을 지원하려면 Windows Server 2012에 KMS 설치가 업데이트되어야 합니다. 자세한 내용은[2016 년 7 월 업데이트 롤업 Windows Server 2012에 대 한](https://support.microsoft.com/help/3172615/july-2016-update-rollup-for-windows-server-2012)참조입니다. 
>- Windows 10 및 Windows Server 2016 이상의 클라이언트 또는 서버 운영 체제를 실행하는 클라이언트의 정품 인증을 지원하려면 Windows 8.1 또는 Windows Server 2012 R2에 KMS 설치가 업데이트되어야 합니다. 자세한 내용은[2016 년 7 월 업데이트 롤업 Windows 8.1 및 Windows Server 2012 r 2에 대 한](https://support.microsoft.com/help/3172614/july-2016-update-rollup-for-windows-8.1-and-windows-server-2012-r2)참조입니다.  
...
컴퓨터를 KMS 호스트, MAK 또는 Windows 정품 버전에서 KMS 클라이언트로 변환하는 경우 해당하는 KMS 클라이언트 설정 키를 설치합니다. 자세한 내용은[KMS 클라이언트 설정 키](KMSclientkeys.md)를 참조 하세요. 
