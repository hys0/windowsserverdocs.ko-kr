...
- Windows 방화벽 설정을 구성합니다.   
   ...
   3. **도메인**, **개인** 및 **공용** 프로필에 대해 원격 데스크톱(TCP-IN)을 사용하도록 설정합니다(위 그림 참조).
...
5. **암호 사용 기간 제한 없음**을 선택하고 **확인**을 선택
