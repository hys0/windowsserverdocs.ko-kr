...
## <a name="what-is-windows-server-software-defined-datacenter"></a>Windows Server 소프트웨어 정의 데이터 센터란 무엇입니까? ##
...
## <a name="windows-server-software-defined-wssd-solutions"></a>WSSD(Windows Server 소프트웨어 정의) 솔루션 ##
...
![](media/sddc/learn.png)**[Microsoft 프로젝트 Windows Admin Center 자세히 알아보기](manage/windows-admin-center/overview.md)**
