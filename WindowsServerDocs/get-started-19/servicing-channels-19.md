---
title: 서비스 채널
description: 'Windows Server 서비스 채널: LTSC 및 SAC에 대한 설명'
...
ms.locfileid: "9149769"
---
# Windows Server 서비스 채널: LTSC 및 SAC
...
## 반기 채널 
반기 채널은 소프트웨어 정의 하이브리드 데이터 센터 뿐 아니라 응용프로그램(특히 컨테이너와 마이크로 서비스에 빌드된 응용프로그램)에서 새 운영 체제 기능을 신속하게 이용하기 위해 빠르게 혁신하고 있는 고객에게 적합합니다. 반기 채널의 Windows Server 제품은 1년에 두 번, 봄과 가을에 새 릴리스가 제공됩니다. 이 채널의 각 릴리스는 최초 릴리스 후 18개월 동안 지원됩니다.
...
## Windows Server 2019 및 Windows Server 버전 1809 식별 방법
