...
## <a name="BKMK_Selectingdirect-video-connectedorUSBzeroclientstationdevices"></a>직접\-비디오\-연결 된 또는 USB 제로 클라이언트 스테이션 장치 선택  
...
## <a name="BKMK_SelectingRDP-over-LAN-connectedstationhardware"></a>\-LAN을 통해 RDP\-선택\-연결 된 스테이션 하드웨어  
