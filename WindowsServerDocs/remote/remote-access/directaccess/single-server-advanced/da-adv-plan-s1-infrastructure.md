...
원격 액세스 관리 콘솔에 **GPO (GPO 이름)을 찾을 수 없습니다**합니다. 구성 설정을 제거하려면 다음 단계를 따릅니다.  
