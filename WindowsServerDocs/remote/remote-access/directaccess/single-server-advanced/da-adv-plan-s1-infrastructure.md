...
3.  다음 표에 따라 필요한 어댑터 및 주소를 구성합니다. 단일 네트워크 어댑터를 사용하고 NAT 장치 뒤에 설치되는 배포의 경우 **내부 네트워크 어댑터** 열만 사용하여 IP 주소를 구성합니다.  
    ...
    > [!NOTE]  
    > -   DirectAccess 클라이언트에 공용 IPv4 주소가 할당된 경우 DirectAccess 클라이언트는 6to4 전환 기술을 사용하여 인트라넷에 연결합니다. 프라이빗 IPv4 주소를 할당된 경우에는 Teredo를 사용합니다. DirectAccess 클라이언트는 6to4 또는 Teredo를 사용하여 DirectAccess 서버에 연결할 수 없는 경우 IP-HTTPS를 사용합니다.  
