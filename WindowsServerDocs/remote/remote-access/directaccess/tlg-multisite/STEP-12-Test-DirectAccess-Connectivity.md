...
14. 에 **시작** 화면에서 입력**\\\2-App1\Files**, 한 다음 ENTER를 누릅니다. 예제에서는 텍스트 파일을 두 번 클릭 합니다.  
  
    이 corp2.corp.contoso.com 도메인 EDGE1 통해 연결 된 경우의 파일 서버에 연결할 수 있음을 보여 줍니다.  
  
15. 에 **시작** 화면에서 입력**\\\App2\Files**, 한 다음 ENTER를 누릅니다. 새 텍스트 문서 파일을 두 번 클릭합니다.  
...
12. 에 **시작** 화면에서 입력**\\\App1\Files**, 한 다음 ENTER를 누릅니다. 예제에서는 텍스트 파일을 두 번 클릭 합니다.  
  
    이 2 EDGE1 통해 연결 된 경우 corp.contoso.com 도메인의 파일 서버에 연결할 수 있음을 보여 줍니다.  
  
13. 에 **시작** 화면에서 입력**\\\App2\Files**, 한 다음 ENTER를 누릅니다. 새 텍스트 문서 파일을 두 번 클릭합니다.  
