...
> [!NOTE]  
> Hyper-v 네트워크 가상화는 테 넌 트가 고유한 주소 공간을 가져오고 Csp를 사용 하 여 확장성을 향상 시킬 수 있도록 하는 네트워크 가상화[NVGRE](https://tools.ietf.org/html/draft-sridharan-virtualization-nvgre-00)(Generic Routing 캡슐화)를 사용 하는 네트워크 오버레이 기술입니다. 테 넌 트 격리를 위한 Vlan.  
...
## <a name="bkmk_clustering"></a>고가용성을 위해 RAS 게이트웨이 클러스터링  
