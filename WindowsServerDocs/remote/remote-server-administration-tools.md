...
Windows 10 용 원격 서버 관리 도구를 사용 하 여 Windows Server 2019, Windows Server 2016, Windows Server 2012 r 2 2008 2012를 실행 하는 컴퓨터에서 특정 기술을 관리할 수 있습니다.
...
주문형 기능의 장점 중 하나는 설치 된 기능이 Windows 10 버전 업그레이드에 유지 된다는 것입니다.
