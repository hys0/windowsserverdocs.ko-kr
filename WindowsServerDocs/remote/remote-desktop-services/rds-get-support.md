...
description: 자세한 내용을 보려면 rds.에 대 한 도움말을 어디에 대 한 링크를 제공 합니다.
ms.custom: na
...
ms.locfileid: "59881374"
---
# <a name="additional-remote-desktop-resources"></a>원격 데스크톱 리소스 추가

정보 외에 여기에 Windows Server 2016 라이브러리에 대해 알아보고 원격 데스크톱 서비스를 활용 하려면 다음 리소스를 사용할 수 있습니다.

- Twitter? 따라서 할까요: [@RDS4U](https://twitter.com/RDS4U)
- 원격 데스크톱 서비스에 대 한 토론 참여 일반적는 [RDS TechNet 포럼](https://aka.ms/technetforum-rds)합니다.
- Windows, Android, iOS 및 Mac에 대 한 원격 데스크톱 응용 프로그램/클라이언트에 대 한 토론에 대 한 참조는 [원격 데스크톱 클라이언트 TechNet 포럼](https://aka.ms/technetforum-rdc)합니다.
