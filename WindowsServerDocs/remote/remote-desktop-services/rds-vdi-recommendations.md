...
**파일 시스템**을 펼치고, **NTFS**를 두 번 클릭하고, **짧은 이름 만들기 옵션**을 두 번 클릭하고, **사용** 라디오 단추를 선택한 다음, **옵션** 풀다운 메뉴를 사용하여 **모든 볼륨에서 사용**을 선택합니다. **확인** 단추를 클릭하여 저장합니다.
