...
iOS 클라이언트는 현재 Swiftpoint GT 및 ProPoint 마우스를 지원합니다. 디바이스 지원에 대한 자세한 내용은 [iOS 클라이언트의 새로운 기능](ios-whatsnew.md) 및 [iOS App Store](https://aka.ms/rdios)를 참조하세요.
