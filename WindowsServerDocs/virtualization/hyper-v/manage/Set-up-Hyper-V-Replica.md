...
-   **복구 지점을**: 가상 컴퓨터의 복제 설정을 구성한 경우 여기에서 저장 하려는 복구 지점을 지정 합니다. 복구 지점을 가상 컴퓨터를 복구할 수 있는 시간에 스냅샷을 나타냅니다. 가장 최근 복구 지점에서 복구 하는 경우 분명 하지 않는 데이터의 손실 됩니다. 복구 지점에 액세스할 수 있습니다 최대 24 시간 전입니다.  
