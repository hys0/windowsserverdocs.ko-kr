---
title: 최소한 필요한 가상 컴퓨터의 Windows Server 2008 r 2를 실행 하 고 동적 메모리에 사용할 수 있는 메모리 양을 구성합니다
...
ms.locfileid: "71365052"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-server-2008-r2-and-enabled-for-dynamic-memory"></a>최소한 필요한 가상 컴퓨터의 Windows Server 2008 r 2를 실행 하 고 동적 메모리에 사용할 수 있는 메모리 양을 구성합니다
...
## <a name="issue"></a>문제점  
*하나 이상의 가상 컴퓨터가 Windows Server 2008 r 2에 필요한 메모리 용량 보다 더 작은 동적 메모리를 사용 하도록 구성 되어 있습니다.*  
