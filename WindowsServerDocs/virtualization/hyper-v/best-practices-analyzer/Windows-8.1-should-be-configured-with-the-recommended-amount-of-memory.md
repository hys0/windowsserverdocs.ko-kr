---
title: Windows 8.1 권장된 메모리 양은로 구성 해야
...
ms.locfileid: "59871294"
---
# <a name="windows-81-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 8.1 권장된 메모리 양은로 구성 해야
...
## <a name="issue"></a>**문제점**  
*Windows 8.1 실행 하는 가상 컴퓨터는 1GB ram 권장된 크기 보다 더 적은 노력으로 구성 됩니다.*  
