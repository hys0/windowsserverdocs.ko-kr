---
title: Windows Server 2012 r 2를 실행 하 고 동적 메모리를 사용 하 여 구성 하는 가상 컴퓨터 메모리 설정에 대 한 권장된 값을 사용 해야
...
## <a name="issue"></a>문제점  
*하나 이상의 가상 컴퓨터는 Windows Server 2012 R2에 대 한 권장 하는 메모리 용량 보다 더 적은 노력으로 동적 메모리를 사용 하도록 구성 됩니다.*  
...
*Hyper-v 관리자를 사용 하 여 최소 메모리 256MB 이상, 시작 메모리에 최소 512 MB 이상 및 최소 2GB이 가상 머신에 대 한 최대 메모리를 늘리세요.*  
