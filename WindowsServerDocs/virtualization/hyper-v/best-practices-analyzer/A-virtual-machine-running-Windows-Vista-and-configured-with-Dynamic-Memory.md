...
## <a name="issue"></a>문제점  
*하나 이상의 가상 컴퓨터는 Windows Vista에 대 한 권장 하는 메모리 용량 보다 더 적은 노력으로 동적 메모리를 사용 하도록 구성 됩니다.*  
...
*Hyper-v 관리자 또는 Windows PowerShell을 사용 하 여 적어도 256MB, 시작 메모리에 최소 512 MB 이상 및 최대 메모리를 1GB 이상에 최소 메모리를 늘리십시오.*  
