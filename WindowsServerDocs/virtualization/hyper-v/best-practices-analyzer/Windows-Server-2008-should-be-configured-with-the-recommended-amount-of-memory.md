---
title: Windows Server 2008 권장된 메모리 양은로 구성 해야
...
ms.locfileid: "59818794"
---
# <a name="windows-server-2008-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows Server 2008 권장된 메모리 양은로 구성 해야
...
*Windows Server 2008을 실행 하는 가상 머신 권장 되는 2GB RAM 용량 보다 더 적은 노력으로 구성 됩니다.*  
...
3.  다음과 비슷한 명령을 실행, 교체 \<MyVM > 가상 컴퓨터와 메모리의 이름으로 값을 적어도 아래 표시 된 값입니다.  
