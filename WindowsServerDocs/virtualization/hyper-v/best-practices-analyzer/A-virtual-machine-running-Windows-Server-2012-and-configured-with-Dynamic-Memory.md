...
## <a name="issue"></a>**문제점**  
*하나 이상의 가상 컴퓨터가 Windows Server 2012에 권장 되는 메모리 용량 보다 더 작은 동적 메모리를 사용 하도록 구성 되어 있습니다.*  
...
*Hyper-v 관리자를 사용 하 여 최소 256, 시작 메모리를 최소 512 MB 이상,이 가상 컴퓨터의 최대 메모리를 2gb 이상으로 늘립니다.*  
