...
## <a name="issue"></a>문제점  
*하나 이상의 가상 컴퓨터가 Windows Server 2008 r 2에 권장 되는 메모리 용량 보다 더 작은 동적 메모리를 사용 하도록 구성 되어 있습니다.*  
...
*Hyper-v 관리자 또는 Windows PowerShell을 사용 하 여 최소 메모리를 256 MB 이상, 시작 메모리를 최소 512 MB, 최대 메모리를 2gb 이상으로 늘립니다.*  
