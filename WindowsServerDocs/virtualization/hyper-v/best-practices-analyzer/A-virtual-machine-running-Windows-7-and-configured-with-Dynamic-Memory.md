---
title: Windows 7을 실행 하 고 동적 메모리를 사용 하 여 구성 하는 가상 컴퓨터 메모리 설정에 대 한 권장된 값을 사용 해야
...
ms.locfileid: "59885014"
---
# <a name="a-virtual-machine-running-windows-7-and-configured-with-dynamic-memory-should-use-recommended-values-for-memory-settings"></a>Windows 7을 실행 하 고 동적 메모리를 사용 하 여 구성 하는 가상 컴퓨터 메모리 설정에 대 한 권장된 값을 사용 해야
...
## <a name="issue"></a>문제점  
*하나 이상의 가상 컴퓨터는 Windows 7에 대 한 권장 하는 메모리 용량 보다 더 적은 노력으로 동적 메모리를 사용 하도록 구성 됩니다.*  
...
5.  아래에서 **동적 메모리**,  변경 된 **최소 RAM** 256mb 이상 및 **최대 RAM** 512MB로  
