---
title: Windows Server 2012 R2 해야 적어도 최소 메모리 양을 사용 하 여 구성
...
ms.locfileid: "71364432"
---
# <a name="windows-server-2012-r2-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Server 2012 R2 해야 적어도 최소 메모리 양을 사용 하 여 구성
...
## <a name="issue"></a>**문제점**  
*Windows Server 2012 r 2를 실행 하는 가상 머신은 최소 RAM 용량 (512 MB 미만)으로 구성 됩니다.*  
