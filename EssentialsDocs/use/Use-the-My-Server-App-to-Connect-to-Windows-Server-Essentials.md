...
-   [새로운 My Server 2012 R2의 새로운 기능](Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md#BKMK_WhatsNew)  
...
-   [새로운 My Server 2012 R2의 새로운 기능](../use/Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md#BKMK_WhatsNew)  
...
##  <a name="BKMK_WhatsNew"></a> 새로운 My Server 2012 R2의 새로운 기능  
...
2.  서버에서 사용자 계정을 사용 하 여 Windows Server Essentials 서버에 로그인 합니다. 서버를 식별하려면  
    ...
    -   이전 예제에서 서버 이름을 사용 하 여 인트라넷을 통해 온-프레미스를 연결 하는 경우, 서버 이름은 **마케팅**합니다. (온-프레미스에 연결 하는 Windows 8 또는 Windows RT 컴퓨터를 사용 하는 경우이 메서드를 사용 하려면 설치 해야 CAROOT.cer 인증서를 서버에서. 자세한 내용은 [Windows 8, Windows 8.1 또는 Windows RT 장치에서 My Server에 대 한 인증서를 설치 하려면](#BKMK_InstallCert).)  
...
|기능 집합|설명|  
|-----------------|-----------------|  
|경고 관리|-(관리자 전용) 해결 서버에서 경고 또는 안 작업을 요구 하는 경고를 무시 합니다. 알림 켜기/끄기(**사용 권한** 설정, **알림** 옵션)<br />-(표준 사용자 계정) 네트워크 상태 경고 보기입니다.<br />     **참고:** My Server에서 경고를 보려는 사용자에 대 한 합니다 **사용자는 네트워크 상태 경고를 볼 수 있습니다** 설정을 선택 해야 **일반** 사용자 계정의 설정 합니다. 자세한 내용은 [Manage user accounts using the Dashboard](../manage/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage8)를 참조하세요.|  
...
|**최근 항목** 표시 사용자 지정|**최근 항목** 목록에서는 현재 작업 중인 파일에 빠르게 액세스할 수 있습니다. 다음과 같이 변경할 수 있습니다.<br /><br /> -표시할 최근 파일 히스토리의 일 수를 설정 합니다. (**최근 항목** 설정: **최근 항목에 유지할 기간(일)**, 기본값 = 7일)<br />-선택을 취소 합니다 **최근** 더 이상 사용 하 여 작업 중인 파일을 작업 해야 할 경우를 표시 합니다. 이 작업은 캐시에 영향을 주지 않습니다. 여전히 오프라인에서 파일을 사용할 수 있습니다. (**최근 항목** 설정: **지우기** 단추)<br />     **팁:** T 필요한 오프 라인 파일에 액세스할 경우, 사용할 **모두 지우기** 에서 **오프 라인** 캐시에서 파일을 제거 하려면 설정 합니다.|  
