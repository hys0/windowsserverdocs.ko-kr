...
ms.locfileid: "66435908"
---
# <a name="use-remote-web-access-in-windows-server-essentials"></a>Windows Server Essentials에서 원격 웹 액세스 사용

>적용 대상: Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials
  
  원격 웹 액세스 기능은 어디에서 나 액세스 파일/폴더를 웹 브라우저를 통해 네트워크에 있는 컴퓨터 수 있는 Windows 서버 Essentials의 인터넷에 연결 합니다. 
  
  원격 웹 액세스를 사용하면 자리를 비울 때 Windows Server Essentials 네트워크에 연결된 상태를 유지할 수 있습니다. 원격 웹 액세스에 로그온 할 때 Windows Server Essentials 네트워크에 있는 컴퓨터에 연결 수, Windows Server Essentials 네트워크를 관리 하 여 대시보드를 엽니다 및 모든 공유 폴더와 미디어 파일 서버에 액세스 합니다.  
...
###  <a name="BKMK_1"></a> 원격 웹 액세스에 로그온  
 로컬 또는 원격 컴퓨터에서 원격 웹 액세스에 로그온 할 때에 네트워크에서 컴퓨터 및 Windows Server Essentials를 실행 하는 서버에서 리소스를 액세스할 수 있습니다.  
  
##### <a name="to-log-on-to-remote-web-access-from-a-network-computer"></a>네트워크 컴퓨터에서 원격 웹 액세스에 로그온하려면  
  
1.  웹 브라우저를 열고 형식 **https://***< 서버 이름\>***/원격** 주소 표시줄에 다음 Enter 키를 누릅니다.  
  
    > [!NOTE]
    >  Https에서 s를 포함 하는 있는지 확인 합니다.  
  
2.  원격 웹 액세스 로그온 페이지에 텍스트 상자에 사용자 이름 및 암호를 입력 하 고 화살표를 클릭 합니다.  
  
##### <a name="to-log-on-to-remote-web-access-from-a-remote-computer"></a>원격 컴퓨터에서 원격 웹 액세스에 로그온하려면  
  
1.  웹 브라우저를 열고 형식 **https://***< YourDomainName\>***/원격** 주소 표시줄에 다음 Enter 키를 누릅니다.  
  
    > [!NOTE]
    >  도메인 이름 정보에 대해서는 네트워크 관리자에게 문의하세요. Https에서 s를 포함 하는 있는지 확인 합니다.  
  
2.  원격 웹 액세스 로그온 페이지에 텍스트 상자에 사용자 이름 및 암호를 입력 하 고 화살표를 클릭 합니다.  
  
###  <a name="BKMK_1.5"></a> 컴퓨터에 원격으로 액세스  
 사무실을 비울 때 Windows Server Essentials 대시보드, 공유 폴더와 네트워크에 있는 컴퓨터를 원격으로 액세스 하려면 원격 웹 액세스 사이트에 로그온 할 웹 브라우저를 사용할 수 있습니다.  
...
-   [만들기, 이름 바꾸기, 이동, 삭제 또는 원격 웹 액세스에서 파일 및 폴더 복사](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)  

-   [원격 웹 액세스에서 파일 업로드 및 다운로드](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_UploadRWA)  
  
-   [만들기, 이름 바꾸기, 이동, 삭제 또는 원격 웹 액세스에서 파일 및 폴더 복사](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)  
...
-   Windows Server Essentials에서 파일과 폴더를 이동, 삭제하고 이름을 바꿉니다. 자세한 내용은 [만들기, 이름 바꾸기, 이동, 삭제 또는 복사 파일 및 원격 웹 액세스에서 폴더](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)합니다.  

-   Windows Server Essentials에서 파일과 폴더를 이동, 삭제하고 이름을 바꿉니다. 자세한 내용은 [만들기, 이름 바꾸기, 이동, 삭제 또는 복사 파일 및 원격 웹 액세스에서 폴더](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)합니다.  
...
- **Windows 압축 폴더 (.zip)**  
  ...
  > [!NOTE]
  >  이 옵션에는 Windows Server Essentials에서 국제 파일 이름에 대 한 제한 된 지원을 제공합니다.  
...
-   [모바일 장치에 대 한 지원 되는 웹 브라우저](Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_9)  

-   [모바일 장치에서 원격 웹 액세스 사용](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_8)  
  
-   [모바일 장치에 대 한 지원 되는 웹 브라우저](../use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_9)  
...
###  <a name="BKMK_9"></a> 모바일 장치에 대 한 지원 되는 웹 브라우저  
