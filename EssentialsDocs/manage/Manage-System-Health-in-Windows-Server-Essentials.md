...
>  Windows Server Essentials 및 Windows Server Essentials Experience 역할이 설치 된 Windows Server 2012 R2에서 서버 및 네트워크의 클라이언트 컴퓨터에 대 한 상태 경고는 경고 뷰어에 더 이상 표시 됩니다 있지만 대신 볼 수 없습니다는  **상태 보고서** 탭의 **홈** 페이지입니다.  
 ...
 Windows Server Essentials 서버에 연결 되 고 경고 문제를 관리자와 관련 된 중요 업데이트를 포함 하 여 시스템의 상태, 맬웨어 보호를 클라이언트에서 오래 된 바이러스 정의 누락 된 모든 컴퓨터를 적극적으로 모니터링 컴퓨터 및 작업을 필요로 하는 다른 중요 한 문제입니다. 이러한 문제는 서버 대시보드나 클라이언트 컴퓨터의 실행 패드 또는 Windows Server Essentials에서에서 시작할 수 있는 경고 뷰어에 경고로 표시 되는 **상태 보고서** Windows Server Essentials에서 탭 합니다. 기본적으로 경고는 30분마다 새로 고쳐지지만 **상태 보고서** 탭 또는 경고 뷰어에서 **새로 고침**을 클릭하여 언제든지 네트워크에 경고가 있는지 평가할 수 있습니다.  
...
>   
>  **Windows Server Essentials의 경우:** 기본적으로 상태 보고서 추가 기능에 Windows Server Essentials 또는 Windows Server 2012 R2를 사용 하 여 Windows Server Essentials Experience 역할이 설치 된와 통합 상태 보고서에 표시 되는 **상태 보고서** 탭 대시보드 **홈** 페이지입니다.  
...
- **저장소** 드라이브 및 해당 용량 목록이 **세부 정보** 섹션에 제공됩니다.  
  ...
  기본적으로 보고서에 포함되지 않은 일부 데이터 요소가 필요하지 않으면 작업 창에서 **상태 보고서 설정 사용자 지정**을 클릭하고 **콘텐츠** 탭을 클릭하여 보고서 콘텐츠를 사용자 지정할 수 있습니다. 보고서에 표시 하지 않을 콘텐츠의 확인란의 선택을 취소 합니다. 예를 들어 고유한 서버 백업 계획이 있고 서버 백업에 대 한 경고를 표시 하지 않을 경우 백업을 제외할 수 있습니다 서버 보고서에서 선택을 취소 하 여 합니다 **서버 백업** 확인란 합니다.  
...
> [!NOTE]
>  기본적으로 상태 보고서 추가 기능에 Windows Server Essentials 또는 Windows Server 2012 R2를 사용 하 여 Windows Server Essentials Experience 역할이 설치 된와 통합 상태 보고서에 표시 되는 **상태 보고서** 탭 대시보드 **홈** 페이지입니다.  
