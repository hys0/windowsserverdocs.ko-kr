...
|5|작업 창|작업 창에는 특정 개체(예: 사용자 계정 또는 컴퓨터) 또는 개체 범주의 전역 설정에 대한 속성을 관리하도록 도와주는 정보 및 도구의 링크가 포함됩니다. 작업 창은 다음 두 섹션으로 구분됩니다.<br /><br /> **작업 개체** 도움이 되는 정보와 도구의 œ Contains 링크 (예: 사용자 계정 또는 컴퓨터) 목록 뷰에서 선택한 개체에 대 한 속성을 관리 합니다.<br /><br /> **전역 작업** 도움이 되는 정보와 도구의 œ Contains 링크 관리 기능 영역에 대 한 전역 작업입니다. 전역 작업에는 새 개체 추가, 정책 설정 등의 작업이 포함됩니다.|  
|6|정보 및 설정|이 섹션에서는 서버 설정에 대한 직접 액세스 및 보고 있는 대시보드 페이지에 대한 정보의 도움말 링크를 제공합니다.|  
|7|경고 상태|경고 상태를 통해 서버 상태를 빠르게 시각적으로 확인할 수 있습니다. 경고 이미지를 클릭하여 중요한 경고를 확인합니다.<br /><br /> **참고:** Windows Server Essentials 및 Windows Server 2012 R2 Standard 설치 Windows Server Essentials Experience 역할을 경고 상태는 사용할 수 있습니다 합니다 **정보와 설정을** 탭 합니다.|  
|8|상태 표시줄|상태 표시줄에는 목록 뷰에 나타나는 개체 수가 표시됩니다. 추가 기능 응용 프로그램은 다른 상태를 표시할 수도 있습니다.|  
  
##  <a name="BKMK_Home"></a> 대시보드 홈 페이지의 기능  
 대시보드를 열면 기본적으로 **홈** 페이지가 나타나고 **설정** 범주가 표시됩니다. Windows Server Essentials 대시보드의 **홈** 페이지에서는 서버를 사용자 지정하고 주요 기능을 구성하도록 도와주는 작업 및 정보에 빠르게 액세스할 수 있습니다. 홈 페이지는 선택한 옵션에 대한 정보 및 구성 작업을 표시하는 기능 영역 4개로 구성됩니다. 다음 표에서 기능을 설명 합니다.  
...
##  <a name="BKMK_Features"></a> 대시보드의 관리 섹션  
...
|섹션|설명|  
|-------------|-----------------|  
|홈|**홈** 페이지는 대시보드를 열 때마다 기본적으로 표시됩니다. 이 페이지에는 다음 범주의 작업 및 정보가 포함됩니다.<br /><br /> **설치** œ 처음으로 서버를 구성 하려면이 범주의 작업을 완료 합니다. 이러한 작업에 대 한 자세한 내용은 [설치 및 Windows Server Essentials 구성](../install/Install-and-Configure-Windows-Server-Essentials.md)합니다.<br /><br /> **전자 메일** œ 서버를 사용 하 여 전자 메일 서비스를 통합 하려면이 범주의 옵션을 선택 합니다.<br /><br /> **참고:** 이 범주에만 Windows Server Essentials에서 제공 됩니다.<br /><br /> **서비스** œ 서버와 Microsoft 온라인 서비스를 통합 하려면이 범주의 작업을 선택 합니다.<br /><br /> **참고:** 이 범주는만 사용 하도록 설정 하는 Windows Server Essentials Experience 역할을 사용 하 여 Windows Server Essentials 및 Windows Server 2012 R2 Standard에서 사용할 수 있습니다.<br /><br /> **추가 기능** œ 비즈니스에 대 한 유용한 추가 기능을 설치 하려면이 범주를 클릭 합니다.<br /><br /> **빠른 상태** œ 개략적인 서버 상태를 표시 합니다. 상태를 클릭하여 해당 기능에 대한 정보 및 구성 옵션을 확인합니다. 설정 범주의 모든 작업을 완료하면 범주 창 위쪽에 이 범주가 나타납니다.<br /><br /> **도움말** œ 검색 상자를 사용 하 여 웹에서 도움말을 검색 합니다. 링크를 클릭하여 선택한 지원 옵션에 대한 웹 사이트를 방문합니다.|  
|사용자|사용자가 Windows Server Essentials에서 제공하는 리소스에 액세스하게 하려면 Windows Server Essentials 대시보드를 사용하여 사용자 계정을 만들어야 합니다. 사용자 계정을 만들고 나서 대시보드의 **사용자** 페이지에서 사용할 수 있는 작업을 통해 계정을 관리할 수 있습니다. 이 페이지에서 수행할 수 있는 작업은 다음과 같습니다.<br /><br /> -사용자 계정 목록을 봅니다.<br /><br /> -보기 및 사용자 계정 속성을 관리 합니다.<br /><br /> 정품 인증 또는 사용자 계정을 비활성화 합니다.<br /><br /> 추가 또는 사용자 계정을 제거 합니다.<br /><br /> -로컬 네트워크 계정을 할당할 Microsoft online services 계정에 서버에 Office 365와 통합 되는 경우.<br /><br /> -사용자 계정 암호를 변경 하 고 암호 정책을 관리 합니다.<br /><br /> 사용자 계정을 관리 하는 방법에 대 한 내용은 [Manage User Accounts](Manage-User-Accounts-in-Windows-Server-Essentials.md)합니다.|  
...
##  <a name="BKMK_AccessDb"></a> Windows Server Essentials 대시보드 액세스  
...
###  <a name="BKMK_Server"></a> 서버에서 대시보드 액세스  
...
###  <a name="BKMK_Network"></a> 네트워크에 연결 되어 있는 컴퓨터에서 대시보드 액세스  
...
2.  인터넷 브라우저 주소 표시줄에 다음을 입력 합니다.**https://<DomainName\>/원격**여기서 *DomainName* (예: contoso.com) 조직의 외부 도메인 이름입니다.  
  
3.  사용자 이름 및 원격 웹 액세스 사이트에 로그인 할 암호를 입력 합니다.  
  
4.  에 **컴퓨터** 원격 웹 액세스의 섹션**홈** 페이지 서버를 찾습니다 하 고 클릭 **Connect**합니다.  
    ...
    >   
    >  원격 웹 액세스에서 대시보드에 액세스할 사용자 권한을 부여 하려면 사용자 계정에 대 한 속성 페이지를 열고 다음을 선택 합니다 **서버 대시보드** 옵션을 합니다 **원격 액세스** 탭 합니다.  
...
##  <a name="BKMK_UseSafeMode"></a> 안전 모드 사용  
 ...
 언제든지 서버에 설치된 모든 추가 기능 목록을 볼 수 있습니다. 모든 타사 추가 기능을 자동으로 사용하지 않도록 설정하는 안전 모드에서 대시보드를 열 수도 있습니다. Windows Server Essentials를 사용하여 네트워크의 다른 컴퓨터에서 대시보드에 안전 모드로 액세스할 수 있습니다.  
