...
ms.locfileid: "66433144"
---
# <a name="manage-user-accounts-in-windows-server-essentials"></a>Windows Server Essentials에서 사용자 계정 관리

>적용 대상: Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials

Windows Server Essentials 대시보드의 사용자 페이지에서는 소규모 기업 네트워크에서 사용자 계정 관리를 도와주는 정보와 작업을 중앙화합니다. 사용자 대시보드의 개요를 보려면 [대시보드 개요](Overview-of-the-Dashboard-in-Windows-Server-Essentials.md)합니다.  
...
-   [사용자 계정을 비활성화합니다](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage6)  
...
-   해당 하는 경우 (Windows Server Essentials에서 Office 365 계정이 라고도 함)는 Microsoft Online Services 계정을 할당 합니다.  
  
-   사용자 그룹 (Windows Server Essentials에만 해당)을 할당 합니다.  
  
> [!NOTE]
> - Microsoft Azure Active Directory (Azure AD)에서 비 ASCII 문자를 사용 하는 것이 없습니다. 서버를 Azure AD와 통합 되는 경우에 암호에서 비 ASCII 문자를 사용 하지 마십시오.  
...
###  <a name="BKMK_Remove"></a> 사용자 계정 제거  
...
> [!IMPORTANT]
>  사용자 계정에 Microsoft 온라인 계정 할당 경우 때 사용자 계정을 제거 하면, 또한 online 계정에 Microsoft Online Services에서 제거 되 고 메일을 포함 한 사용자가의 데이터를 Microsoft Online Services 대 한 보존 정책이 데이터 적용 됩니다. 온라인 계정에 대한 사용자 데이터를 유지하려면 사용자 계정을 제거하는 대신 비활성화합니다. 자세한 내용은 [사용자에 대 한 온라인 계정 관리](Manage-Online-Accounts-for-Users.md)합니다.  
...
4.  에 **< 사용자 계정\> 태스크** 창 클릭 **사용자 계정을 제거**합니다. 사용자 계정 삭제 마법사가 나타납니다.  
  
5.  에 **파일을 유지 하 시겠습니까?** 페이지는 마법사의 파일 히스토리 백업 및 사용자 계정에 대 한 리디렉션된 폴더를 포함 하 여 사용자가의 파일을 삭제 하도록 선택할 수 있습니다. 사용자가의 파일을 유지 하려면 확인란을 비워 둡니다. 선택하고 나서 **다음**을 클릭합니다.  
  
6.  **계정 삭제**를 클릭합니다.  
  
> [!NOTE]
>  사용자 계정을 제거하고 나면 계정이 더 이상 사용자 계정 목록에 나타나지 않습니다. 서버에서 사용자가의 폴더를 영구적으로 삭제 하는 파일을 삭제 하도록 선택한 경우 합니다 **사용자** 서버 폴더 및 합니다 **파일 히스토리 백업** 서버 폴더입니다.  
>   
...
2.  에 **< 사용자 계정\> 태스크** 창 클릭 **계정 속성 보기**합니다. 사용자 계정에 대한 **속성** 페이지가 나타납니다.  
  
3.  탭을 클릭하여 해당 계정 기능에 대한 속성을 표시합니다.  
  
4.  사용자 계정 속성의 모든 변경 사항을 저장하려면 **적용**을 클릭합니다.  
  
###  <a name="BKMK_Manage4"></a> 사용자 계정에 대 한 표시 이름 변경  
...
###  <a name="BKMK_Manage5"></a> 사용자 계정 활성화  
...
4.  에 **< 사용자 계정\> 태스크** 창 클릭 **사용자 계정을 활성화**합니다.  
...
###  <a name="BKMK_Manage6"></a> 사용자 계정을 비활성화합니다  
 ...
 사용자 계정에 Microsoft 온라인 계정이 할당되어 있으면 온라인 계정도 비활성화됩니다. 사용자는 Office 365 및 구독할 수 없지만 메일을 포함 한 사용자가의 데이터를 Microsoft Online Services 유지 됩니다 하는 기타 온라인 서비스의 리소스를 사용할 수 없습니다.  
...
4.  에 **< 사용자 계정\> 태스크** 창 클릭 **사용자 계정 비활성화**합니다.  
...
###  <a name="BKMK_Manage7"></a> 사용자 계정 이해  
...
###  <a name="BKMK_Manage8"></a> 대시보드를 사용 하 여 사용자 계정 관리  
 Windows Server Essentials에서는 Windows Server Essentials 대시보드를 사용하여 일반적인 관리 작업을 수행할 수 있습니다. 기본적으로 **사용자** 대시보드 페이지에 두 개의 탭이 포함 됩니다 **사용자가** 하 고 **사용자 그룹**합니다.  
  
> [!NOTE]
> - 이라는 새 탭 Office 365를 사용 하 여 Windows Server Essentials를 실행 하는 서버를 통합 하는 경우 **배포 그룹** 에 추가 됩니다 합니다 **사용자** 대시보드의 페이지입니다.  
>   -   Windows Server Essentials에서의 **사용자** 대시보드 페이지에는 단일 탭만 포함 되어 **사용자**합니다.  
...
- 다음을 표시하는 사용자 계정 목록:  
  ...
  -   Windows Server Essentials에서 서버는 Office 365 또는 Windows Intune과 통합 되어 있으면 Microsoft 온라인 계정이 표시 됩니다.  
  
  -   서버는 Microsoft Office 365와 통합 되는 경우에 Windows Server Essentials에서 사용자 계정에 대 한 Office 365 계정 (Windows Server Essentials의 Microsoft 온라인 계정에서)의 상태가 표시 됩니다.  
...
- 다음을 포함하는 작업 창:  
  ...
  다음 표에서는 **사용자** 탭에서 사용할 수 있는 다양한 사용자 계정 작업에 대해 설명합니다. 일부 작업은 사용자 계정 관련 작업이고 목록에서 사용자 계정을 선택할 때만 표시됩니다.  
  
> [!NOTE]
>  Windows Server Essentials와 Office 365를 통합 하는 경우 추가 작업을 사용할 수 있게 됩니다. 자세한 내용은 [사용자에 대 한 온라인 계정 관리](Manage-Online-Accounts-for-Users.md)합니다.  
...
|새로 고침|사용자 탭을 새로 고칩니다.<br /><br /> 이 작업은 Windows Server Essentials에 적용할 수 있습니다.|  
|파일 히스토리 설정 변경|백업 빈도 또는 백업 기간 등의 파일 히스토리 설정을 변경할 수 있습니다.<br /><br /> 이 작업은 Windows Server Essentials에 적용할 수 있습니다.|  
|모든 원격 연결 내보내기|최근 30일 동안 발생한 서버에 대한 모든 원격 연결의 .CSV 형식 파일을 만듭니다.|  
  
##  <a name="BKMK_ManageAccess"></a> 암호 및 액세스 관리  
 다음 항목에서는 Windows Server Essentials 대시보드를 사용하여 서버에서 사용자 계정 암호와 공유 폴더에 대한 사용자 액세스 권한을 관리하는 방법을 설명합니다.  
  
-   [사용자 계정의 암호를 재설정 또는 변경](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access1)  
  
-   [암호 정책에 대 한 알아야 할 사항](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access3)  
...
-   [유지 및 제거 된 사용자 계정에 대 한 파일에 대 한 액세스 관리](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access6)  
  
-   [네트워크 관리자 암호와 DSRM 암호 동기화](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access7)  
  
-   [사용자 계정에 원격 데스크톱 권한 부여](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access8)  
  
-   [사용자가 서버의 리소스에 액세스할 수 있게](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access9)  
...
-   [자신의 컴퓨터에 원격 데스크톱 세션을 설정 하려면 사용자 계정 허용](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access13)  
  
###  <a name="BKMK_Access1"></a> 사용자 계정의 암호를 재설정 또는 변경  
...
4. 에 **< 사용자 계정\> 태스크** 창 클릭 **사용자 계정 암호를 변경**합니다. 사용자 계정 암호 변경 마법사가 나타납니다.  
...
7. 사용자에게 새 암호를 제공합니다.  
   ...
   >   -   비 ASCII 문자를 Azure AD에서 지원 되지 않습니다. 따라서 서버와 Azure AD와 통합 하는 경우 암호에 비 ASCII 문자가 사용 하지 마십시오.  
   >   -   Microsoft 온라인 계정 (Office 365 계정으로 Windows Server Essentials에서) 사용자에 게 할당 되 면 암호가 온라인 계정 암호를 사용 하 여 동기화 됩니다. 사용자는 새 암호를 사용하여 서버 또는 Office 365에 로그인합니다. 자세한 내용은 [사용자에 대 한 온라인 계정 관리](Manage-Online-Accounts-for-Users.md)합니다.  
  
###  <a name="BKMK_Access3"></a> 암호 정책에 대 한 알아야 할 사항  
...
###  <a name="BKMK_Access6"></a> 유지 및 제거 된 사용자 계정에 대 한 파일에 대 한 액세스 관리  
 네트워크 관리자는 사용자 계정을 제거 하 고 사용자 향후 사용에 대 한 s 파일을 유지 하도록 선택할 수 있습니다. 이 시나리오에서 제거된 사용자 계정은 더 이상 네트워크에 로그인하는 데 사용되지 않지만, 이 사용자에 대한 파일은 공유 폴더에 저장되어 다른 사용자와 공유할 수 있습니다.  
  
> [!IMPORTANT]
>  Microsoft 온라인 계정이 할당된 사용자 계정을 제거하면 온라인 계정도 제거되고 메일을 포함한 사용자 데이터에는 Microsoft Online Services의 데이터 보존 정책이 적용됩니다. 온라인 계정에 대한 사용자 데이터를 유지하려면 사용자 계정을 제거하지 않고 비활성화합니다. 자세한 내용은 [사용자에 대 한 온라인 계정 관리](Manage-Online-Accounts-for-Users.md)합니다.  
  
##### <a name="to-remove-a-user-account-but-retain-access-to-the-user-s-files"></a>사용자 계정을 제거 하지만 사용자가의 파일에 대 한 액세스를 유지 합니다.  
...
###  <a name="BKMK_Access7"></a> 네트워크 관리자 암호와 DSRM 암호 동기화  
 ...
 Windows Server Essentials을 처음 새로 설치하는 동안 프로그램에서는 설정 중에 지정하거나 마이그레이션 응답 파일에서 지정한 네트워크 관리자 계정 암호로 DSRM 암호를 설정합니다. (권장된 대로 서버 보안 강화를 위해 일반적으로 60일마다) 네트워크 관리자 암호를 변경해도 암호 변경이 DSRM에 전달되지 않습니다. 이 때문에 암호가 일치하지 않습니다. 이 경우에 수동으로 다음 솔루션을 사용 하 여 수도 있고 DSRM 암호를 사용 하 여 네트워크 관리자가의 암호를 자동으로 동기화 할 수 있습니다.  
...
5.  작업 동작을 정의합니다.  
    ...
    3.  에 **인수를 추가**(선택 사항) 텍스트 상자에서 다음을 입력 합니다 (따옴표를 포함 해야 함): **도메인 계정 SBS_network_administrator_account 질문 및 답변 질문 및 답변에서에서 dsrm 암호 동기화 설정** 여기서  *SBS_network_administrator_account* 현재 네트워크 관리자가의 계정 이름입니다.  
  
6.  **확인** 을 두 번 클릭하여 작업을 저장하고 **작업 만들기** 대화 상자를 닫습니다. 새 작업이 **작업 일정**의 **활성 작업** 섹션에 나타납니다.  
  
###  <a name="BKMK_Access8"></a> 사용자 계정에 원격 데스크톱 권한 부여  
...
- 원격 웹 액세스  
  ...
  원격 액세스에 대 한 자세한 내용은 참조 하세요. [Manage Anywhere Access](Manage-Anywhere-Access-in-Windows-Server-Essentials.md)합니다.  
  
###  <a name="BKMK_Access9"></a> 사용자가 서버의 리소스에 액세스할 수 있게  
  이 섹션에는 Windows Server Essentials Experience 역할이 설치 된 Windows Server 2012 R2 Standard 또는 Windows Server 2012 R2 Datacenter 실행 서버 또는 Windows Server Essentials 또는 Windows Server Essentials를 실행 하는 서버에 적용 됩니다.  
  
 사용자가 원격 액세스를 사용하고 개별 사용자 계정을 보유하도록 하려면 컴퓨터를 서버에 연결하고 나서 대시보드를 사용하여 서버에서 네트워크로 연결된 컴퓨터 사용자에 대한 새 네트워크 사용자 계정을 만들 수 있습니다. 사용자 계정을 만드는 방법에 대한 자세한 내용은 [Add a user account](Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage1)를 참조하세요. 사용자 계정을 만들고 나서 클라이언트 컴퓨터의 사용자가 실행 패드를 사용하여 서버의 리소스에 액세스할 수 있도록 해당 사용자에게 네트워크 사용자 이름 및 암호 정보를 제공해야 합니다.  
...
4.  에 **< 사용자 계정\> 태스크** 창 클릭 **계정 속성 보기**합니다.  
  
5.  에 **< 사용자 계정\> 속성**, 다음을 수행 합니다.  
...
###  <a name="BKMK_Access11"></a> 사용자 계정에 대 한 가상 개인 네트워크 사용 권한 변경  
...
###  <a name="BKMK_Access12"></a> 사용자 계정에 대 한 내부 공유 폴더에 대 한 액세스 변경  
...
5.  **< FolderName\> 속성**, 클릭 **공유**에 나열 된 사용자 계정에 대 한 적절 한 사용자 액세스 수준을 선택 하 고 클릭 **적용**합니다.  
  
    > [!NOTE]
    >  **파일 히스토리 백업**, **폴더 리디렉션**및 **사용자** 서버 폴더에 대한 공유 권한은 수정할 수 없습니다. 또한 이러한 서버 폴더의 폴더 속성에는 **공유** 탭이 포함되지 않습니다.  
  
###  <a name="BKMK_Access13"></a> 자신의 컴퓨터에 원격 데스크톱 세션을 설정 하려면 사용자 계정 허용  
  이 섹션에는 Windows Server Essentials Experience 역할이 설치 된 Windows Server 2012 R2 Standard 또는 Windows Server 2012 R2 Datacenter 실행 서버 또는 Windows Server Essentials 또는 Windows Server Essentials를 실행 하는 서버에 적용 됩니다.  
...
5.  에 **< 사용자 계정\> 속성**를 클릭 합니다 **컴퓨터 액세스** 탭 합니다.  
