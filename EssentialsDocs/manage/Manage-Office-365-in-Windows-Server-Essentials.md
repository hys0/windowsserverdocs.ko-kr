...
ms.locfileid: "66433284"
---
# <a name="manage-office-365-in-windows-server-essentials"></a>Windows Server Essentials에서 Office 365 관리

>적용 대상: Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials

Windows Server Essentials 서버에 Microsoft Office 365와 통합 하면 Windows Server Essentials 대시보드에서 온-프레미스 리소스와 함께 Office 365 서비스 및 온라인 계정을 관리할 수 있습니다. 이 항목에서는 Office 365를 사용 하 여 서버를 통합 하 여 얻을 수 있는 이점, 이렇게 하는 방법 및 관리 하 고 Office 365 통합 문제를 해결 하는 방법을 알아봅니다.  
...
##  <a name="BKMK_IntegrationOverview"></a> 내 서버를 사용 하 여 Office 365를 통합 해야는 이유  
 Windows Server Essentials 서버를 사용 하 여 Office 365를 통합 하는 좋은 이유는 여러 가지가 있습니다. 일부 리소스를 사내에서 관리 해도 다른 서비스에 대 한 Office 365를 사용 하는 경우 두 위치에서 작업 하는 대신 온-프레미스 리소스와 함께 대시보드에서 Office 365 서비스 및 리소스를 관리할 수 있습니다.  
...
- SharePoint Online 라이브러리를 포함 하는 구독의 경우 Windows Server Essentials 서버를 사용 하 여 Office 365 통합 수 있습니다.  
  ...
  - 대시보드에서 SharePoint Online 라이브러리를 만들고 설정 합니다.  
    ...
    > [!NOTE]
    >  또한 My Server 2012 R2 앱을 사용 하 여 랩톱, 모바일 장치 또는 Windows phone에서 SharePoint Online 라이브러리의 문서를 작업할 수 있습니다. 이 기능은 Windows Server Essentials에 사용할 수만 있습니다. 자세한 내용은 [Use the My Server App](../use/Use-the-My-Server-App-to-Connect-to-Windows-Server-Essentials.md)합니다.  
...
##  <a name="BKMK_Configure"></a> Office 365 통합 설정  
 서버 설치를 완료 한 후 언제 든 지 Office 365를 사용 하 여 서버를 통합할 수 있습니다. Office 365 구독이 없는 경우에 구매 하거나 무료 평가판 구독에 등록 수 있습니다.  
...
-   [3단계: (선택 사항) Office 365에 조직의 인터넷 도메인 이름 연결](#BKMK_StepThree)  
...
-   전자 메일 주소 및 SharePoint Online 리소스를 사용 하 여 조직의 인터넷 도메인을 사용 하려는 경우에 통합 하는 동안 Office 365에 도메인을 연결할 수 있도록 도메인 이름을 등록 해야 합니다. 자세한 내용은 [도메인 이름 구매 방법](https://office.microsoft.com/office365-suite-help/how-to-buy-a-domain-name-HA102819883.aspx?CTT=5&origin=HA102818660)을 참조하세요.  
  
> [!NOTE]
>  Office 365를 미리 구독 하지 않아도 됩니다. 구독을 구입 하거나 Office 365 통합 하는 동안 무료 평가판에 등록할 수 있습니다. 계획 및 Office 365에 대 한 가격을 확인 하려는 경우 [기업 위한 Office 365 계획 비교](https://office.microsoft.com/compare-office-365-for-business-plans-FX102918419.aspx?CR_CC=200061904&WT.srch=1&WT.mc_ID=PS_bing_O365Comm_subscribe-to-office-365_Text)합니다.  
...
> [!NOTE]
>  프로시저의 Windows Server Essentials 또는 Windows Server Essentials 있지만 홈 페이지의 다른 위치에서 시작 하는지 여부를 동일 합니다. Windows Server Essentials에서 Office 365 및 기타 Microsoft Online Services 사용 하 여 서버 통합을 **Services** 탭 합니다. Windows Server Essentials에서 Office 365 통합을 수행 합니다 **전자 메일** 탭 합니다.  
...
3. **시작** 페이지에서 다음 작업의 하나를 수행합니다.  
   ...
   -   Office 365에 대 한 구독이 없으면 클릭 **다음**, 평가판 구독에 Office 365 또는 기호를 구독에 대 한 지침을 따릅니다.  
  
        마법사를 반환 하기 전에 Office 365에 로그인 해야 합니다. 작업을 수행할 필요가 있지만 합니다 **여기에서 시작** Office 365 포털의 섹션입니다.  
  
   -   선택 된 서버와 통합 하려는 Office 365를 구독에 이미 있는 경우 **Office 365에 대 한 구독을 이미가지고**를 클릭 하 고 **다음**합니다.  
  
4. 지시에 따라 마법사를 완료합니다.  
  
   마법사를 성공적으로 완료 된 후에 대시보드에 다음 변경 내용을 보면:  
  
-   새로운 **Office 365** 통합 및 Office 365 구독 관리에 사용 되는 페이지입니다.  
  
-   에 **사용자** 페이지를 볼 수는 **온라인 계정을** 만들고 Office 365에 사용자 액세스를 부여 하는 Microsoft Online Services 계정을 관리할 수 있는 탭입니다. Windows Server Essentials 서버에 있고 Exchange Online을 사용 하는 경우 또한 표시를 **배포 그룹** 탭 합니다.  
...
###  <a name="BKMK_StepThree"></a> 3 단계: (선택 사항) Office 365에 조직의 인터넷 도메인 이름 연결  
 ...
 대량-온라인 계정을 만들 때 도메인을 사용할 수 있도록 사용자에 대 한 온라인 계정을 만들기 전에이 작업을 수행 하는 것이 쉽습니다.  
  
 Office 365에 등록할 때 도메인 이름을 얻으려면? 예를 들어 *contoso*. onmicrosoft.com입니다. 다른 도메인 이름을 사용 하려는 경우? 예를 들어 contoso.com 단순히? 할 수 있습니다. 이미 하나를 소유 하 고 일부 DNS 레코드를 변경 하지 경우 도메인 이름을 구입 해야 합니다.  
...
1. **도메인 이름을 구매합니다.** 즉, 도메인 등록 기관 또는 DNS 호스팅 공급자에 등록합니다.  
   ...
   -   Office 365에 필요한 도메인 이름 서버 (DNS) 레코드를 허용 하는 도메인 등록 기관에서 구매 합니다. 필요한 DNS 레코드를 허용하는 도메인 등록 기관을 확인하려면 [도메인 이름 구매 방법](https://office.microsoft.com/office365-suite-help/how-to-buy-a-domain-name-HA102819883.aspx?CTT=5&origin=HA102818660)을 참조하세요. 다른 등록 기관에 도메인을 이미 등록 한 경우 걱정 하지 마십시오. Office 365에 도메인을 연결 하면 다른 등록 기관에 도메인을 전송할 수 있습니다.  
  
2. **Office 365 서비스에서 도메인 이름을 사용하도록 허용하는 DNS 레코드를 구성합니다.** 가장 쉬운 방법은 3 단계에서 Office 365 구독에 도메인을 연결 하면 DNS 레코드를 구성 마법사를 통해 하는 것입니다. 수행 하는 대신 직접, 참조 [Office 365 통합에 대 한 레코드를 수동으로 DNS를 구성 하는 방법](#BKMK_ManuallyConfigureDNS)합니다.  
  
3. **Office 365 구독에 사용자 지정 인터넷 도메인을 연결 합니다.** 사용 된 **Office 365에 도메인 연결** 작업 합니다.  
...
3.  마법사에서 도메인 이름 서버에서 관리 되지 않는 있는지를 감지 하면 구성을 완료 하려면 필요한 DNS 레코드를 수동으로 구성 해야 합니다. 자세한 지침은 이 항목의 후반부에서 [Office 365 통합에 대한 DNS 레코드를 수동으로 구성하는 방법](#BKMK_ManuallyConfigureDNS)을 참조하세요.  
  
4.  Office 365에서 도메인 사용 되 고 있는지 확인 합니다.  
  
     도메인 이름 등록 기관이 DNS 레코드를 확인 하는 동안 마법사를 완료 한 후에 거의 대기입니다. 자동으로 이런 아무 작업도 수행할 필요가 없습니다. 일반적으로 약 1 시간 소요 되지만? 및 경우에 따라 약간 더 오래입니다. 도메인 확인이 완료 되는 **Office 365** 페이지에 조직의 도메인이 나열 됩니다.  
  
####  <a name="BKMK_ManuallyConfigureDNS"></a> Office 365 통합에 대 한 DNS 레코드를 수동으로 구성 하는 방법  
 Office 365에 도메인 연결 마법사에서 도메인 이름이 서버에서 관리되지 않음을 감지할 경우 구성을 완료하려면 필요한 DNS(도메인 이름 서버) 레코드를 수동으로 구성해야 합니다. 이 경우에 구성 해야 하는 DNS 레코드 목록을 볼 **%username%\NewDNSRecords_ (n).txt**, 여기서 *(n)* 은 임의 숫자입니다.  
...
|Exchange Online|별칭(CNAME)|사용자가 Exchange Online과 Outlook 데스크톱 클라이언트 또는 모바일 전자 메일 클라이언트 사이의 연결을 손쉽게 설정하도록 도와주는 데 사용되는 자동 검색 레코드입니다. **참고:**  조직의 자체 도메인 이름을 사용 하 여 Outlook Web Access에 액세스 하려는 경우 (예를 들어 http://mail.contoso.com) 표준 URL 대신 (https://outlook.com/owa/office365.com), 별칭 (CName) 레코드를 다음과 같이 구성할 수 있습니다. **Type=CNAME, TTL=01:00:00, HostName=mail, Address=mail.office365.com**|  
...
-   사용자에 대한 Microsoft Online Services 계정을 만듭니다.  
     ...
     Office 365 서비스를 사용 하려면 사용자에 게 네트워크 사용자 계정과 연관 된 Microsoft Online Services 계정이 있어야 합니다. 대시보드에서 쉽게 만들 수 있습니다. 새 Office 365 구독을 사용 하는 경우 대량으로 만들 수 있습니다 온라인 계정을 기존 사용자 계정에 대 한 합니다. 이미 사용 중인 Office 365 구독과 새 서버를 통합 하는 경우에 기존 온라인 계정에서 사용자 계정을 가져올 수 있습니다. 절차를 참조 하세요 [사용자에 대 한 온라인 계정 관리](Manage-Online-Accounts-for-Users.md)합니다.  
...
-   [Office 365에 조직의 인터넷 도메인 연결](#BKMK_StepThree) ? 사용자가 도메인으로 주소가 지정 된 전자 메일을 주고받을 수 하려는 경우 Office 365에 도메인을 연결할 수 있습니다. (앞에서 설명한 [3 단계: Office 365에 조직의 도메인 연결](#BKMK_StepThree).)  
  
-   [Office 365 통합 사용 안 함](#BKMK_Disable) ? 대시보드에서 Office 365 서비스, 구독 및 온라인 계정을 관리 하지 않으려는 경우에 Office 365 통합을 비활성화할 수 있습니다. 서비스를 Office 365 포털에서 사용할 수 있습니다.  
  
###  <a name="BKMK_ManageO365"></a> Office 365 구독 관리  
 서버에서 작업 하는 동안 Office 365 구독을 변경 해야 할 경우에서 Office 365에서 구독을 열 수 있습니다 합니다 **Office 365** 대시보드의 페이지입니다. 또한 Office 365 서비스를 변경 하는 서버 관리자 계정을 변경할 수 있습니다.  
...
###  <a name="BKMK_Disable"></a> Office 365 통합 사용 안 함  
 대시보드에서 Office 365 서비스 및 온라인 계정을 관리 하려는 하지 않으려면 Office 365 통합을 비활성화할 수 있습니다. Office 365 구독을 활성 상태로 유지 되 고 대시보드에서 변경한 모든 구성 변경 내용을 적용 합니다. 예를 들어 Office 365 구독에 연결 된 도메인 이름으로 배달 하는 전자 메일을 받게 됩니다. 메일을 잃지 및 모바일 장치에 설정 하는 컨트롤은 여전히 Exchange Online을 사용 합니다.  
  
 앞으로 Office 365 구독, 서비스 및 Office 365에서 리소스 관리는 및 사용자가 Office 365에서 온라인 계정에 대 한 암호를 관리 해야 합니다. 암호 동기화가 더 이상 발생 하 고 사용 하지 않도록 설정 또는 사용자 계정을 제거 하는 사용자의 온라인 계정에 영향을 주지 않습니다.  
...
> [!NOTE]
>  Office 365 통합을 다시 활성화 하려면 사용 합니다 **Office 365와 통합** 작업을 합니다 **서비스** 대시보드 탭 **홈** 페이지. 자세한 내용은 [2 단계: Microsoft Office 365와 Windows Server Essentials 서버 통합](#BKMK_StepTwo)이 항목의 앞부분에 나오는.  
 ...
 **설명**  
 ...
 대시보드에서 하나 이상의 Microsoft Online Services 계정을 만들려는 시도가 성공 하지 않습니다.  
