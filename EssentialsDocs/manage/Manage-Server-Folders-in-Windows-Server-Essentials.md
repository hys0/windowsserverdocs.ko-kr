...
ms.locfileid: "66433198"
---
# <a name="manage-server-folders-in-windows-server-essentials"></a>Windows Server Essentials에서 서버 폴더 관리

>적용 대상: Windows Server 2016 Essentials, Windows Server 2012 R2 Essentials, Windows Server 2012 Essentials
  
 서버 관리자를 관리할 수 있습니다 (공유 폴더에서 실행 패드, 원격 웹 액세스, Windows Phone 용 내 서버 앱 또는 Windows 8 용 내 서버 앱에 액세스할 때 라고도 함) 모든 서버 폴더에 대 한 액세스 서버에서의 작업을 사용 하 여는  **서버 폴더** 대시보드를 사용자에 게 다양 한 파일에 대 한 액세스 수준을 허용을 탭 합니다.  
...
-   [서버 폴더를 이동 하거나 추가](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_5)  
...
|폴더 속성 보기|선택한 폴더에 대한 속성을 표시하고 이를 통해 다음을 수행할 수 있습니다.<br /><br /> -사용자가 만든 폴더의 이름을 변경 합니다.<br /><br /> 선택한 폴더에 대 한 설명을 변경 합니다.<br /><br /> -폴더의 크기를 확인 합니다.<br /><br /> -파일 탐색기에서 선택한 폴더를 엽니다.<br /><br /> -선택한 폴더에 대 한 사용자 계정 액세스 권한을 지정 합니다.<br /><br /> -원격 웹 액세스 및 웹 서비스 응용 프로그램에서 선택한 폴더를 숨깁니다.<br /><br /> -폴더 할당량을 지정 합니다.|  
...
-   [서버 폴더에 사용 권한 집합](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Perms)  
...
4.  에 **< 서버 폴더\> 태스크** 창 클릭 **폴더 속성 보기**합니다.  
  
5.  **< FolderName\> 속성**, 클릭 **공유**선택 **원격 웹 액세스 및 웹 서비스 응용 프로그램에서이 폴더 숨기기**를 클릭 하 고 **적용**합니다.  
  
###  <a name="BKMK_Perms"></a> 서버 폴더에 사용 권한 집합  
...
> [!NOTE]
>  Windows Server Essentials 및 Windows Server Essentials Experience 역할이 설치 된 Windows Server 2012 R2에서 폴더 할당량을 수정할 수도 있습니다.  
...
5.  **< Foldername\> 속성**에 **일반** 탭에서 보거나 이름 및 서버 폴더의 설명을 수정 합니다.  
  
    > [!NOTE]
    >  Windows Server Essentials 및 Windows Server Essentials Experience 역할이 설치 된 Windows Server 2012 R2에서 서버 폴더에 지정 된 크기에 도달할 때 경고 메시지를 제공 하는 폴더 할당량을 수정할 수도 있습니다.  
  
##  <a name="BKMK_5"></a> 서버 폴더를 이동 하거나 추가  
...
###  <a name="BKMK_6"></a> 추가 하거나 서버 폴더를 이동 하는 위치  
...
4. 지시에 따라 마법사를 완료합니다.  
   ...
   >   -   원격 웹 액세스를 통해 액세스할 수 있는 서버 폴더를 정의할 수 있습니다. 자세한 내용은 [Manage access to server folders](Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_1)를 참조하세요.  
...
##  <a name="BKMK_9"></a> 누락 된 서버 폴더 추가  
 때 서버에서 검색 하는 미리 정의 된 서버 폴더? 회사, 사용자, 클라이언트 컴퓨터 백업, 파일 히스토리 백업 또는 폴더 리디렉션? 더 이상 공유 (어떤 이유로 든 또는 다른)에 대해 경고가 발생 하는이 문제를 해결 하려면 사용자를 안내 합니다. 서버 백업에서 폴더를 복원해 보는 것이 좋습니다. 그러나 서버가 백업되지 않았으면 누락된 폴더를 선택하고 **누락된 폴더 다시 만들기**를 클릭하여 서버 폴더의 위치를 다시 구성합니다.  
  
> [!NOTE]
>  미리 정의 된 폴더 중 하나만? 회사, 사용자, 클라이언트 컴퓨터 백업, 파일 히스토리 백업 또는 폴더 리디렉션? 다시 만들 수 있습니다. 사용자가 만든 서버 폴더 및 미디어 서버 폴더는 다시 만들 수 없습니다.  
  
 누락된 폴더를 복원하거나 다시 만들고 나면 해당 폴더가 더 이상 **없음**으로 나열되지 않습니다.  
  
 서버 백업에서 파일을 복원 하는 방법에 대 한 내용은 자세한 섹션 항목의 파일 및 폴더 복원에 대 한 [Manage Backup and Restore](Manage-Backup-and-Restore-in-Windows-Server-Essentials.md)합니다.  
  
##  <a name="BKMK_11"></a> 공유 폴더 이해  
 서버에 연결된 장치에서 다양한 방법으로 Windows Server Essentials의 공유 폴더에 액세스할 수 있습니다. 자세한 내용은 항목을 참조 하세요 [Use Shared Folders](../use/Use-Shared-Folders-in-Windows-Server-Essentials.md)합니다.  
