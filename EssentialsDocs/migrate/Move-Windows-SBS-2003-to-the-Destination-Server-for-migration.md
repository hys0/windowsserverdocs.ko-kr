...
3. [(선택 사항) 이전 로그온 스크립트 제거](#remove-old-logon-scripts)

4. [레거시 Active Directory 그룹 정책 개체 (선택 사항)를 제거 합니다.](#remove-legacy-active-directory-group-policy-objects) 
